...
export const HELPER_ADDON_ENV = "HAWKNEXT_CUA_HELPER_ADDON";
export const WINDOWS_DEV_CONTROL_PROTOCOL = "hawknext-cua-windows-dev/v1";
...
export function isPotentialHawkNextCuaAgentMcpServer(_server) {
  return false;
}
