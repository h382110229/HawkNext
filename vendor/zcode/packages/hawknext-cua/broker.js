...
export const BROKER_SOCKET_ENV = "HAWKNEXT_CUA_PERMISSION_BROKER_SOCKET";
export const BROKER_UNAVAILABLE_ENV = "HAWKNEXT_CUA_PERMISSION_BROKER_UNAVAILABLE";
...
export function mintBrokerSocketPath(options = {}) {
  ...
  return join(dir, `hawknext-cua-broker-${randomUUID()}.sock`);
}
