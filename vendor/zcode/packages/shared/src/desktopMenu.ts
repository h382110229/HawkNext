...
export const desktopMenuMessageIds = {
  ...
  helpToggleHawkNextStdioTap: "titleBar.menu.help.toggleHawkNextStdioTap",
  helpHawkNextEndpoint: "titleBar.menu.help.hawknextEndpoint",
  helpHawkNextEndpointProduction: "titleBar.menu.help.hawknextEndpoint.production",
  helpHawkNextEndpointTest: "titleBar.menu.help.hawknextEndpoint.test",
  helpHawkNextEndpointCustom: "titleBar.menu.help.hawknextEndpoint.custom",
  helpHawkNextEndpointReset: "titleBar.menu.help.hawknextEndpoint.reset",
  ...
  trayOpenHawkNext: "tray.menu.openHawkNext",
...
export const desktopMenuMessages: Record<Locale, DesktopMenuLocaleMessages> = {
  "zh-CN": {
    ...
    "titleBar.menu.help.hawknextEndpoint": "HawkNext Endpoint",
    "titleBar.menu.help.hawknextEndpoint.production": "Production（默认）",
    "titleBar.menu.help.hawknextEndpoint.test": "Test",
    "titleBar.menu.help.hawknextEndpoint.custom": "自定义...",
    "titleBar.menu.help.hawknextEndpoint.reset": "恢复默认",
    ...
    "tray.tooltip": "HawkNext",
    "tray.menu.openHawkNext": "打开 HawkNext",
    "tray.menu.quit": "退出",
  },
  "en-US": {
    ...
    "titleBar.menu.help.hawknextEndpoint": "HawkNext Endpoint",
    "titleBar.menu.help.hawknextEndpoint.production": "Production (default)",
    "titleBar.menu.help.hawknextEndpoint.test": "Test",
    "titleBar.menu.help.hawknextEndpoint.custom": "Custom...",
    "titleBar.menu.help.hawknextEndpoint.reset": "Reset to default",
    ...
    "tray.tooltip": "HawkNext",
    "tray.menu.openHawkNext": "Open HawkNext",
    "tray.menu.quit": "Quit",
  },
};
