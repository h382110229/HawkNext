export const HAWKNEXT_AGENT_PROVIDER_NOT_READY_CODE = "HAWKNEXT_AGENT_PROVIDER_NOT_READY" as const;
export const HAWKNEXT_AGENT_PROVIDER_NOT_READY_REASON = "provider_not_ready" as const;
