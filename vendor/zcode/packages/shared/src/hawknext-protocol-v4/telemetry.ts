import { z } from "zod";
import { hawknextSyntheticUserMessageSourceSchema } from "../hawknext-protocol-legacy-types.js";
...
const turnStartedFactSchema = z
  .object({
    ...
    inputSource: hawknextSyntheticUserMessageSourceSchema.optional(),
...
const toolLifecycleFactSchema = z
  .object({
    ...
    skillSource: z.enum(["agents", "hawknext", "bundled", "plugin", "remote"]).optional(),
...
type TurnStartedConversationTelemetryFact = Extract<
  ...
  { kind: "turn.started" }
> &
  import("../hawknext-task-types-core.js").HawkNextBackgroundTurnAttribution;
