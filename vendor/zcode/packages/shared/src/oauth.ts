...
/** 内置 CloudCN provider id */
export const CLOUD_CN_PROVIDER_ID = "disabled-cloud-cn" as const;

/** 内置 ZAI provider id */
export const CLOUD_INTL_PROVIDER_ID = "disabled-cloud-intl" as const;

/** 凭据解密失败错误前缀 */
export const CREDENTIAL_DECRYPT_ERROR_PREFIX = "凭据解密失败：" as const;

/** 凭据解密失败稳定错误码 */
export const CREDENTIAL_DECRYPT_ERROR_CODE = "HAWKNEXT_CREDENTIAL_DECRYPT_FAILED" as const;
...
export type OAuthProviderId =
  | typeof CLOUD_CN_PROVIDER_ID
  | typeof CLOUD_INTL_PROVIDER_ID
...
/** Host 在检测到 HawkNext JWT 失效后通知 Renderer 展示确认并重启。 */
export const HAWKNEXT_JWT_INVALID_BROADCAST_CHANNEL = "auth:hawknext-jwt-invalid";
