...
export const HAWKNEXT_FILE_LOCK_TIMEOUT_ERROR_CODE = "HAWKNEXT_FILE_LOCK_TIMEOUT" as const;
...
export function isHawkNextFileLockTimeoutError(error: unknown): boolean {
  return normalizeUnknownError(error).code === HAWKNEXT_FILE_LOCK_TIMEOUT_ERROR_CODE;
}
