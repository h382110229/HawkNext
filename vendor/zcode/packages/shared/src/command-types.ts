...
export type CommandAgentSource = "hawknextAgent";
...
export type HawkNextCommand = UserCommand | PluginCommand;

export function isUserCommand(command: HawkNextCommand): command is UserCommand {
  return command.source === "user";
}

export function isPluginCommand(command: HawkNextCommand): command is PluginCommand {
