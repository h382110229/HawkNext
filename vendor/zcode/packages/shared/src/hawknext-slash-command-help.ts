export type BuiltinHawkNextSlashCommandHelpEntry = {
...
export const BUILTIN_HAWKNEXT_SLASH_COMMAND_HELP_ENTRIES: readonly BuiltinHawkNextSlashCommandHelpEntry[] =
  [
    {
      details: [
    ...
    },
    {
      details: [
        ...
        " and CloudCN browser login poll for authorization, then securely save credentials and refresh available models.",
        "Manual API key variants accept the API key as an argument.",
      ],
      name: "login",
      summary: "Set up a Coding Plan provider.",
      usage:
        "/login [zai-coding-plan|cloud-cn-coding-plan|zai-coding-plan-api-key <api-key>|cloud-cn-coding-plan-api-key <api-key>]",
    },
    {
      details: ["Deletes  OAuth credentials from the shared HawkNext credential store."],
      name: "logout",
      summary: "Remove the shared  login credentials.",
      usage: "/logout",
    },
    {
    ...
    },
    {
      details: [
        ...
        "This command targets the workspace root, not the user default ~/.hawknext/AGENTS.md.",
      ],
      name: "init",
