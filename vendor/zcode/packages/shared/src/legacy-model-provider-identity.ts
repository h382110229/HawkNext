...
export function migrateLegacyOfficialGlmModelId(providerId: string, modelId: string): string {
  return /^(?:builtin:(?:zai|cloudCn)(?:-start-plan|-coding-plan)?|account:(?:zai|cloudCn)-(?:start-plan|individual-coding-plan|team-coding-plan))$/.test(
    providerId,
  )
...
export function migrateLegacyModelProviderId(providerId: string): string | undefined {
  switch (providerId) {
    case "builtin:cloud-cn":
      return BUILTIN_PROVIDER_TEMPLATE_IDS.cloudCn;
    case "builtin:zai":
      return BUILTIN_PROVIDER_TEMPLATE_IDS.zai;
    case "builtin:cloud-cn-start-plan":
      return BUILTIN_MODEL_PROVIDER_IDS.cloudCnStartPlan;
    case "builtin:zai-start-plan":
      return BUILTIN_MODEL_PROVIDER_IDS.zaiStartPlan;
    case "builtin:cloud-cn-coding-plan":
