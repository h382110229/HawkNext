export type HawkNextAssistantMessagePart =
  | {
      type: "content";
      content: string;
    }
...
export function appendAssistantMessagePart(
  parts: readonly HawkNextAssistantMessagePart[] | undefined,
  nextPart: HawkNextAssistantMessagePart,
) {
...
export function getLatestAssistantContentPart(parts: readonly HawkNextAssistantMessagePart[]) {
...
export function getLatestAssistantContentText(parts: readonly HawkNextAssistantMessagePart[]) {
