...
export const BROWSER_VIEW_RESTORE_BOOTSTRAP_URL = "hawknext-browser-restore://pending";
...
export const LOCAL_MEDIA_PREVIEW_SCHEME = "hawknext-media";
...
export interface HawkNextStdioTapDevState {
  enabled: boolean;
  visible: boolean;
  logDir: string;
  statePath: string;
...
export const DesktopCommandIds = {
  ...
  ToggleHawkNextStdioTapDevProxy: "toggleHawkNextStdioTapDevProxy",
  SetHawkNextEndpointProduction: "setHawkNextEndpointProduction",
  SetHawkNextEndpointTest: "setHawkNextEndpointTest",
  SetHawkNextEndpointCustom: "setHawkNextEndpointCustom",
  ResetHawkNextEndpoint: "resetHawkNextEndpoint",
...
export interface IPlatformService {
  ...
  /** 打开 HawkNext Computer Use 的完整权限引导。Desktop only。 */
  ...
  /** 注册 `hawknext://share/import?code=...` 导入意图。 */
  ...
  /** 导出日志：打包 ~/.hawknext/v2 及外部 agent 日志为 zip 并在系统文件浏览器中显示 */
