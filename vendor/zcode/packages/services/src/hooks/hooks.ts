import type { Hook, HawkNextWorkspaceHookTrustGrantResult } from "@hawknext/shared";
import type { WorkspaceHookBundleSnapshotData } from "@hawknext/shared/workspace-hook-discovery";
