...
import { createCloudCNProviderRuntimeConfig } from "./providers/cloud-cnProviderConfig.js";
...
export function createOAuthRuntimeConfig(env: NodeJS.ProcessEnv = process.env): OAuthRuntimeConfig {
  return {
    providers: [createCloudCNProviderRuntimeConfig(env), createZaiProviderRuntimeConfig(env)],
  };
}
