...
WHERE CASE WHEN json_valid(model_selection) THEN
  json_extract(model_selection, '$.providerId') IN ('account:zai-start-plan', 'account:cloud-cn-start-plan', 'account:zai-individual-coding-plan', 'account:cloud-cn-individual-coding-plan', 'account:zai-team-coding-plan', 'account:cloud-cn-team-coding-plan')
