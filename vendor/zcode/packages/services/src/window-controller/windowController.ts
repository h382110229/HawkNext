...
import type { HawkNextArchivedTaskDeletionResult } from "#src/session/hawknextTaskService.js";
import type {
  HawkNextTaskListItem,
  HawkNextTaskListQuery,
  HawkNextTaskListResult,
} from "../session/hawknextTaskListTypes.js";
...
export type WindowHostControllerTaskListItem = HawkNextTaskListItem & {
...
export interface WindowHostControllerTaskListResult extends Omit<HawkNextTaskListResult, "items"> {
...
export interface IWindowControllerService {
  ...
  listTaskList(params: HawkNextTaskListQuery): Promise<WindowHostControllerTaskListResult>;
  mutateTask(params: {
    address: WindowHostTaskAddress;
