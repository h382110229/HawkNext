import { formatLogPrefix, type TraceId } from "@hawknext/shared";
...
export function createServiceLogger(
  ...
  function write(
    ...
    // 服务层日志过去常被复用到 HawkNext Agent 命名 logger，导致新 HawkNext 路径继续依赖 HawkNext Agent 目录。
    // 这里把通用分级日志抽到独立模块，后续删除 HawkNext Agent runtime 时不会牵连非 HawkNext Agent 服务。
