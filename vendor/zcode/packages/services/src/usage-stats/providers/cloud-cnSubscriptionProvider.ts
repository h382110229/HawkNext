import type { ApiClient, ProviderFamilyDomain } from "@hawknext/shared";
import {
...
import { pickCurrentSubscriptionFromList } from "./cloud-cnUsageQuotaMapper.js";

type SubscriptionSummary = NonNullable<ReturnType<typeof pickCurrentSubscriptionFromList>>;
export async function fetchCloudCNSubscriptionSummary(params: {
  apiClient: ApiClient;
