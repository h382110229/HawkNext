...
// @hawknext/hawknext-cua as part of the single-package merge. This file preserves
...
//
// Why two layers:
//   - `@hawknext/hawknext-cua/broker/server` (51 server files) — broker server +
...
//   - `@hawknext/hawknext-cua/broker` (protocol) — brokerProtocol / helperErrors /
...
export * from "@hawknext/hawknext-cua/broker/server";
