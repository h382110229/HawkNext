...
import { HELPER_ADDON_ENV, WINDOWS_DEV_CONTROL_PROTOCOL } from "@hawknext/hawknext-cua/broker/server";
...
/**
 * Parse a `hawknext-cua-windows-dev/v1` control message from the helper child.
 *
