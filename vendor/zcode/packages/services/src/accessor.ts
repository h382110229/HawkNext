...
import type { IHawkNextTaskService } from "./session/hawknextTaskService.js";
import type { IHawkNextAgentService } from "./hawknext-agent/hawknextAgent.js";
import type { IHawkNextSessionService } from "./hawknext-session/hawknextSession.js";
...
export interface IServiceAccessor {
  ...
  /** 设置页插件管理（UI 不再直触 hawknextAgentService 的 plugins/* 面） */
