...
import { decodeProviderConfigFile, encodeProviderConfigFile } from "@hawknext/provider-node";
import {
...
export const PROVIDER_PROVISIONING_OAUTH_CREDENTIAL_KEYS = [
  ...
  "oauth:cloud-intl:refresh_token",
  "oauth:cloud-intl:user_info",
  "oauth:cloud-cn:access_token",
  "oauth:cloud-cn:refresh_token",
  "oauth:cloud-cn:user_info",
  "hawknext-jwt",
] as const;
