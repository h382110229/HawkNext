...
export class HawkNextStorageStartupGate {
  private current?: HawkNextStorageStartupState;
  private terminalError?: Error;
  private pending?: Promise<void>;
  private resolve?: () => void;
  private reject?: (error: Error) => void;
  private timer?: ReturnType<typeof setTimeout>;
  private readonly changed = new Emitter<HawkNextStorageStartupState>();
  ...
  get snapshot(): HawkNextStorageStartupState | undefined {
    return this.current;
  }

  accept(input: unknown): boolean {
    const parsed = hawknextStorageStartupStateSchema.safeParse(input);
