import type { ServiceAuthorityMode } from "@hawknext/shared";

export type HawkNextAgentPresentationSurface = "desktop";

interface HawkNextAgentPresentationHostFacts {
...
export function resolveHawkNextAgentPresentationSurface(
  facts: HawkNextAgentPresentationHostFacts,
): HawkNextAgentPresentationSurface | undefined {
