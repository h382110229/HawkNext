import { hawknextProtocolMethods, hawknextRuntimeCapabilitiesSchema } from "@hawknext/shared";
import type { HawkNextProtocolClient } from "./hawknextProtocolClient.js";
...
export function ensureIndependentPlanSupport(
  ...
  const check = client
    .request(hawknextProtocolMethods.runtimeCapabilities, {}, hawknextRuntimeCapabilitiesSchema)
    .then((result) => {
