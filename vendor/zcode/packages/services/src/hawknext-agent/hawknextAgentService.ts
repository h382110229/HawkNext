import { requestPluginReferenceCatalog } from "#src/hawknext-agent/pluginReferenceCatalogRequest.js";
import {
  localTtftFactsSchema,
  sessionDebugSnapshotSchema,
  type LocalTtftFacts,
} from "@hawknext/shared";
/* oxlint-disable eslint(max-lines) -- HawkNext Protocol transport、通知 wiring 和 app-facing session 方法必须共享同一个 client/emitter 上下文。 */
import { randomUUID } from "node:crypto";
import { ensureIndependentPlanSupport } from "./independentPlanSupport.js";
import { mkdirSync } from "node:fs";
import { join } from "node:path";
import { Emitter } from "@hawknext/rpc";
...
import { completeNewModelSelection } from "@hawknext/provider";
import type { OffPeakClientConfig } from "#src/coding-plan-subscription/codingPlanSubscription.js";
import {
  HAWKNEXT_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
  formatLogPrefix,
  resolveWorkspaceKey,
  type TraceId,
  HAWKNEXT_AGENT_PROVIDER,
  HAWKNEXT_AGENT_PROVIDER_NOT_READY_CODE,
  HAWKNEXT_AGENT_PROVIDER_NOT_READY_REASON,
  HAWKNEXT_MODEL_REASONING_SEPARATOR,
  isRemoteWorkspaceIdentity,
  HAWKNEXT_PROTOCOL_NAME,
  HAWKNEXT_PROTOCOL_VERSION,
  hawknextMcpListResultSchema,
  hawknextPermissionRequestParamsSchema,
  hawknextBrowserListParamsSchema,
  hawknextBrowserExecuteParamsSchema,
  hawknextPluginsConfigureResultSchema,
  hawknextPluginsInstallResultSchema,
  hawknextPluginsListResultSchema,
  hawknextPluginsMarketplaceMutationResultSchema,
  hawknextPluginsOverviewResultSchema,
  hawknextProcessChildProcessesResultSchema,
  type HawkNextProcessChildProcess,
  hawknextSkillsReferenceCatalogResultSchema,
  hawknextWorkflowsDeleteResultSchema,
  hawknextWorkflowsGetResultSchema,
  hawknextWorkflowsListResultSchema,
  hawknextWorkflowsMoveResultSchema,
  hawknextWorkflowsRunsResultSchema,
  hawknextWorkflowsUpdateMetaResultSchema,
  hawknextPluginsResolveSuggestedReferenceResultSchema,
  hawknextPluginOperationProgressNotificationSchema,
  hawknextPluginsRestoreBuiltinResultSchema,
  hawknextPluginsSetEnabledResultSchema,
  hawknextPluginsCancelOperationResultSchema,
  hawknextPluginsUninstallResultSchema,
  hawknextPluginsValidateResultSchema,
  hawknextPluginsDescribeResultSchema,
  hawknextAutomationCheckTaskBindingParamsSchema,
  hawknextAutomationCreateParamsSchema,
  hawknextAutomationDeleteParamsSchema,
  hawknextAutomationListParamsSchema,
  hawknextAutomationUpdateParamsSchema,
  hawknextOffPeakCreateParamsSchema,
  hawknextOffPeakListParamsSchema,
  OFF_PEAK_PROVIDER_IDS,
  hawknextComputerUseOperationEventSchema,
  hawknextProviderRuntimeHeadersCancelledSchema,
  hawknextProviderRuntimeHeadersRequestParamsSchema,
  hawknextProviderTestModelConnectivityResultSchema,
  hawknextOfficialMcpAuthHeadersRequestParamsSchema,
  summarizeOfficialMcpIdentityHeaders,
  hawknextProtocolEmptyResultSchema,
  hawknextProtocolMethods,
  hawknextProtocolNotifications,
  hawknextMcpTelemetryEventSchema,
  hawknextMcpResourceSamplesSchema,
  hawknextToolExecResourceSchema,
  hawknextProcessResourceSampleSchema,
  hawknextSessionCloseResultSchema,
  hawknextSessionCompactResultSchema,
  hawknextSessionEventsResultSchema,
  hawknextSessionGoalResultSchema,
  hawknextSessionListResultSchema,
  hawknextSessionSubagentsResultSchema,
  hawknextSessionMessagesResultSchema,
  hawknextSessionEventSchema,
  hawknextSessionSendResultSchema,
  hawknextSessionRequestRuntimePreferencesParamsSchema,
  hawknextSessionRuntimePreferencesResultSchema,
  hawknextSessionStateSnapshotSchema,
  hawknextSessionSubscribeResultSchema,
  hawknextStateUpdatedNotificationSchema,
  hawknextUserInputRequestParamsSchema,
  hawknextWorkspacePresentationSchema,
  hawknextWorkspaceCancelGenerateTextResultSchema,
  hawknextWorkspaceGenerateTextResultSchema,
  hawknextWorkspaceHookTrustGrantResultSchema,
  hawknextWorkspaceUpdateInteractionPreferencesResultSchema,
  hawknextWorkspaceUpdateModelIoPreferencesResultSchema,
  hawknextProviderUpdateAccountConfigResultSchema,
  type HawkNextSessionStateSnapshot,
  type HawkNextAutomation,
  type HawkNextAutomationRun,
  hawknextWorkspaceUpdateOffPeakToolPolicyResultSchema,
  hawknextWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
  type DynamicWorkflowClientConfig,
  type AgentLaneResourceSample,
  type ProcessResourceCliLane,
  type HawkNextMcpTelemetryEvent,
  type HawkNextMcpResourceSample,
  type HawkNextToolExecResource,
  type HawkNextPluginOperationProgressNotification,
...
} from "#src/hawknext-agent/automationToolPolicy.js";
import { HAWKNEXT_AGENT_RUNTIME_UNAVAILABLE_CODE } from "./hawknextAgent.js";
import type {
  HawkNextProtocolRequestId,
  ModelSelection,
  HawkNextProviderRuntimeHeadersRequestParams,
  HawkNextSessionEvent,
  HawkNextSessionRuntimePreferencesScope,
  HawkNextSavedWorkflowScope,
  HawkNextStateUpdatedNotification,
  HawkNextWorkspacePresentation,
  HawkNextWorkspaceRef,
  HawkNextSessionRuntimePreferencesResult,
} from "@hawknext/shared";
import type {
  IHawkNextAgentService,
  HawkNextAgentBackgroundBashOutputParams,
  HawkNextAgentAppRuntimePreferences,
  HawkNextAgentRuntimeLifecycleEvent,
  HawkNextAgentAddPluginMarketplaceParams,
  HawkNextAgentAppUsageParams,
  HawkNextAgentCancelPluginOperationParams,
  HawkNextAgentCompactParams,
  HawkNextAgentConfigurePluginParams,
  HawkNextAgentResetPluginConfigParams,
  HawkNextAgentCreateSessionParams,
  HawkNextAgentInstallPluginParams,
  HawkNextAgentGenerateWorkspaceTextParams,
  HawkNextAgentTestModelConnectivityParams,
  HawkNextAgentGoalParams,
  HawkNextAgentGrantWorkspaceHookTrustParams,
  HawkNextAgentInitializeResult,
  HawkNextAgentListSessionsParams,
  HawkNextAgentListSessionSubagentsParams,
  HawkNextAgentReadWorkspacePresentationParams,
  HawkNextAgentReadSessionEventsParams,
  HawkNextAgentReadSessionMessagesParams,
  HawkNextAgentReadSessionParams,
  HawkNextAgentRemovePluginMarketplaceParams,
  HawkNextAgentRespondSessionRuntimePreferencesParams,
  HawkNextAgentResumeSessionParams,
  HawkNextAgentSendPromptParams,
  HawkNextAgentServiceEvent,
  HawkNextAgentSessionSubscribeParams,
  HawkNextAgentSessionTarget,
  HawkNextAgentSessionRuntimePreferencesRequest,
  HawkNextAgentTaskTokenUsageParams,
  HawkNextAgentSetModeParams,
  HawkNextAgentSetModelParams,
  HawkNextAgentSetPluginEnabledParams,
  HawkNextAgentSetThoughtLevelParams,
  HawkNextAgentPluginReferenceCatalogParams,
  HawkNextAgentSkillReferenceCatalogParams,
  HawkNextAgentDeleteSavedWorkflowParams,
  HawkNextAgentGetSavedWorkflowParams,
  HawkNextAgentListSavedWorkflowRunsParams,
  HawkNextAgentListSavedWorkflowsParams,
  HawkNextAgentMoveSavedWorkflowParams,
  HawkNextAgentSavedWorkflowTarget,
  HawkNextAgentUpdateSavedWorkflowMetaParams,
  ...
  HawkNextAgentListMcpServerStatusesParams,
  HawkNextAgentWorkspaceTarget,
  HawkNextAgentCuaPermissionObservation,
  HawkNextAgentCreateAutomationParams,
  HawkNextAgentUpdateAutomationParams,
  HawkNextAgentAutomationIdParams,
  HawkNextAgentSetAutomationEnabledParams,
  HawkNextAgentDeleteAutomationRunParams,
  HawkNextAgentAttachmentBeginParams,
  HawkNextAgentAttachmentChunkParams,
  HawkNextAgentAttachmentReadParams,
  HawkNextAgentConversationAttachmentReadParams,
  HawkNextAgentConversationAttachmentStatParams,
  HawkNextAgentAttachmentPreviewSourceParams,
  HawkNextAgentAttachmentTerminalParams,
  HawkNextAgentConversationCommandParams,
  HawkNextAgentCommandsQueryParams,
  HawkNextAgentConversationFileChangesParams,
  HawkNextAgentConversationFileRewindPreviewParams,
  HawkNextAgentConversationRowsRangeParams,
  HawkNextAgentConversationPlansParams,
  HawkNextAgentConversationWorkflowRunEventsParams,
  HawkNextAgentConversationWorkflowRunArtifactDataParams,
  HawkNextAgentConversationWorkflowRunArtifactReadParams,
  HawkNextAgentConversationWorkflowRunArtifactsParams,
  HawkNextAgentConversationWorkflowRunNodeResultParams,
  HawkNextAgentConversationWorkflowRunWorkspaceParams,
  HawkNextAgentConversationWorkflowRunsParams,
  HawkNextAgentConversationResyncParams,
  HawkNextAgentConversationSubscribeParams,
  HawkNextAgentConversationUnsubscribeParams,
  HawkNextAgentConnectionFlowParams,
  HawkNextAgentSessionsIndexSubscribeParams,
  HawkNextAgentWorkspaceConfigSubscribeParams,
} from "./hawknextAgent.js";
import {
  ...
  utf8JsonByteLength,
  HAWKNEXT_ATTACHMENT_FAULT_CODES,
  HawkNextAttachmentFaultError,
  type CommandAck,
...
} from "@hawknext/shared/hawknext-protocol-v4";
import {
  readTrustedHawkNextAgentV4Connection,
  readTrustedHawkNextAgentV4UnsubscribeRoute,
} from "./hawknextAgentConnectionScope.js";
import { createBackgroundSessionEventCoalescer } from "#src/hawknext-agent/hawknextSessionEventCoalescer.js";
...
import { HawkNextAgentMcpStatusModeUnsupportedError } from "#src/hawknext-agent/hawknextAgentErrors.js";
import { HawkNextAgentProcessManager } from "./hawknextAgentProcessManager.js";
import type { HawkNextAgentProcessManagerOptions } from "./hawknextAgentProcessManager.js";
import type { IOffPeakTaskService } from "#src/session/offPeakTask.js";
import {
  HawkNextProtocolRequestTimeoutError,
  type HawkNextProtocolClient,
} from "./hawknextProtocolClient.js";
import { getDataBaseDir } from "../paths.js";
import {
  collectBrowserAmbientContext,
  type BrowserAmbientContextExecutor,
} from "./hawknextAgentBrowserAmbientContext.js";
import {
...
import type { PipSessionEvent } from "@hawknext/hawknext-cua/pip-session";
import { registerMemoryDiagnosticsProvider } from "#src/memoryDiagnostics.js";

const logger = createServiceLogger("hawknext-agent-service");
...
interface PendingPermissionRequest {
  client: HawkNextProtocolClient;
  protocolRequestId: HawkNextProtocolRequestId;
}

interface PendingProviderRuntimeHeadersRequest extends PendingPermissionRequest {
  request: HawkNextProviderRuntimeHeadersRequestParams;
  responding?: boolean;
}

interface PendingSessionRuntimePreferencesRequest extends PendingPermissionRequest {
  request: HawkNextAgentSessionRuntimePreferencesRequest;
...
function isClosedStdioTransportError(error: unknown): boolean {
  return error instanceof Error && error.message === "HawkNext agent stdio transport is closed";
}
...
function buildWorkspaceRef(params: HawkNextAgentWorkspaceTarget): HawkNextWorkspaceRef {
  return {
...
function savedWorkflowTargetHasWorkspace(
  params: HawkNextAgentSavedWorkflowTarget,
): params is HawkNextAgentWorkspaceTarget & { scope?: HawkNextSavedWorkflowScope } {
  return typeof (params as Partial<HawkNextAgentWorkspaceTarget>).workspacePath === "string";
}

// 只在 `scope` 有定义时下推到 RPC params：不给 scope 的项目档保持与今天逐字一致的线上形状。
function savedWorkflowScopeParam(params: HawkNextAgentSavedWorkflowTarget): {
  scope?: HawkNextSavedWorkflowScope;
} {
  return params.scope === undefined ? {} : { scope: params.scope };
}

function ensurePluginManagementWorkspacePath(): string {
  const workspacePath = join(getDataBaseDir(), ".hawknext", PLUGIN_MANAGEMENT_WORKSPACE_DIR_NAME);
...
// NOTE: this counts ONLY the per-session MCP servers passed through the HawkNext Protocol
// session/create params (the app→protocol channel). It is deliberately independent of the
// CLI/bootstrap MCP servers configured in ~/.hawknext/cli/config.json (mcp.servers), which the agent
// runtime connects separately and reports via the `mcp.server.connected`/toolCount events. So a
// createSession log line with mcpServerCount:0 is EXPECTED when hawknext-cua is a CLI-config MCP server
...
// real kimi-k2.6 turns call mcp__hawknext-cua__* tools (get_app_state/type/open_application, status
...
function isProtocolRequestTimeout(error: unknown, method: string): boolean {
  if (error instanceof HawkNextProtocolRequestTimeoutError) {
    return error.method === method;
  }
  return error instanceof Error && error.message === `HawkNext Protocol request timed out: ${method}`;
}
...
function buildSessionCreateParams(
  params: HawkNextAgentCreateSessionParams & {
...
function buildSessionResumeParams(
  params: HawkNextAgentResumeSessionParams & {
    offPeakToolEnabled?: boolean;
    dynamicWorkflowEnabled?: boolean;
  },
...
function buildSessionSendParams(
  params: HawkNextAgentSendPromptParams,
...
function buildSessionCompactParams(params: HawkNextAgentCompactParams) {
  return {
    sessionId: params.sessionId,
    inputId: params.inputId,
...
function formatModelSelectionForLog(ref: ModelSelection | undefined): string | null {
  ...
  return reasoningLevel ? `${base}${HAWKNEXT_MODEL_REASONING_SEPARATOR}${reasoningLevel}` : base;
}

function sessionEventKey(params: HawkNextAgentSessionTarget): string {
...
function permissionRequestKey(params: HawkNextAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function userInputRequestKey(params: HawkNextAgentSessionTarget & { requestId: string }): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}

function providerRuntimeHeadersRequestKey(
  params: HawkNextAgentSessionTarget & { requestId: string },
): string {
  return `${sessionEventKey(params)}\u0000${params.requestId}`;
}
...
interface HawkNextAgentProviderReadinessSnapshot {
...
): HawkNextAgentProviderReadinessSnapshot {
...
interface WaitingWorkspaceStartup {
  ...
  workspace: HawkNextAgentWorkspaceTarget;
}
...
function createRuntimeUnavailableError(params: HawkNextAgentWorkspaceTarget): Error & {
  code: typeof HAWKNEXT_AGENT_RUNTIME_UNAVAILABLE_CODE;
  workspaceKey: string;
} {
  const error = new Error("HawkNext Agent runtime is not running.") as Error & {
    code: typeof HAWKNEXT_AGENT_RUNTIME_UNAVAILABLE_CODE;
    workspaceKey: string;
  };
  error.code = HAWKNEXT_AGENT_RUNTIME_UNAVAILABLE_CODE;
  error.workspaceKey = resolveWorkspaceKey(params);
  return error;
}

interface CreateHawkNextAgentServiceOptions extends Omit<
  HawkNextAgentProcessManagerOptions,
  "idleTimeoutMs"
> {
  ...
  resolveSessionRuntimePreferences?: (
    scope: HawkNextSessionRuntimePreferencesScope,
  ) => Promise<HawkNextSessionRuntimePreferencesResult>;
  /** manual run 落库后由当前 host 直接派发；返回时 prompt 必须已被 session 接受。 */
  onAutomationManualRunRequested?: (params: {
    automation: HawkNextAutomation;
    run: HawkNextAutomationRun;
  }) => Promise<void>;
  /**
...
function toProtocolAutomation(automation: HawkNextAutomation) {
  return {
...
async function respondOffPeakInternalError(
  client: Pick<HawkNextProtocolClient, "respondError">,
  request: { id: HawkNextProtocolRequestId; method: string },
  workspace: HawkNextAgentWorkspaceTarget,
  error: unknown,
): Promise<void> {
...
export function createHawkNextAgentService(
  options?: CreateHawkNextAgentServiceOptions,
): IHawkNextAgentService & { disposeAllAndWait(): Promise<void> } {
  const processManager = new HawkNextAgentProcessManager(options);
  ...
  const pluginProcessManager = new HawkNextAgentProcessManager({
  ...
  const mcpStatusProcessManager = new HawkNextAgentProcessManager({
    commandResolver: options?.commandResolver,
    presentationSurface: options?.presentationSurface,
  ...
  const sessionEmitters = new Map<string, Emitter<HawkNextAgentServiceEvent>>();
  /**
  ...
  const sessionRuntimePreferencesRequestEmitter =
    new Emitter<HawkNextAgentSessionRuntimePreferencesRequest>();
  const processResourceSampleEmitter = new Emitter<AgentLaneResourceSample>();
  const toolExecResourceEmitter = new Emitter<HawkNextToolExecResource>();
  const mcpResourceSamplesEmitter = new Emitter<HawkNextMcpResourceSample[]>();
  const mcpTelemetryEmitter = new Emitter<HawkNextMcpTelemetryEvent>();
  const pluginOperationProgressEmitters = new Map<
    string,
    Emitter<HawkNextPluginOperationProgressNotification>
  >();
  ...
  const cuaPermissionObservationEmitter = new Emitter<HawkNextAgentCuaPermissionObservation>();
  ...
  const wiredClients = new WeakSet<HawkNextProtocolClient>();
  const clientDisposables = new WeakMap<HawkNextProtocolClient, IDisposable[]>();
  ...
  let latestAppRuntimePreferences: HawkNextAgentAppRuntimePreferences | undefined;
  ...
  const accountConfigSyncByClient = new WeakMap<HawkNextProtocolClient, Promise<void>>();
  // 此缓存只去重已交付的账号快照，不表示 Worker 的 Registry 已应用该版本。
  const accountConfigReceivedRevisionByClient = new WeakMap<HawkNextProtocolClient, string>();
  ...
  function invalidateWorkspaceClient(workspaceKey: string, client: HawkNextProtocolClient): void {
  ...
  async function respondAccountRequestAuthWithoutInteraction(params: {
    ...
    try {
      ...
      logger.info(undefined, "HawkNext provider runtime headers 已应用", {
      ...
      if (pendingProviderRuntimeHeaders.get(params.key) !== params.pending) return;
      logger.warn(undefined, "HawkNext provider runtime headers 应用失败", {
        modelId: params.pending.request.modelSelection.modelId,
        providerId: params.pending.request.providerId,
        requestId: params.pending.request.requestId,
        sessionId: params.pending.request.sessionId,
  ...
  function expireSessionRuntimePreferencesRequest(requestId: string): void {
    ...
    logger.warn(undefined, "运行时偏好请求等待 Host 响应超时", {
      event: "hawknext_agent.runtime_preferences.host_response_timeout",
      module: "services.hawknext_agent",
      requestId,
      scope: pending.request.scope,
      sessionId: pending.request.sessionId,
      timeoutMs: HAWKNEXT_SESSION_RUNTIME_PREFERENCES_REQUEST_TIMEOUT_MS,
    ...
    const current = previous
      ...
      .then(async () => {
        ...
        const result = await params.client.request(
          hawknextProtocolMethods.providerUpdateAccountConfig,
          {
            revision: snapshot.revision,
            basedOnHawkNextBuiltinRevision: snapshot.basedOnHawkNextBuiltinRevision,
        ...
        logger.info(undefined, "account provider config 已交付到 HawkNext agent", {
  ...
  function enqueueInteractionPreferenceSync(params: {
    client: HawkNextProtocolClient;
    preferences: HawkNextAgentAppRuntimePreferences;
    workspace: HawkNextAgentWorkspaceTarget;
  }): Promise<void> {
    ...
    const current = previous
      ...
      .then(async () => {
        await params.client.request(
          hawknextProtocolMethods.workspaceUpdateInteractionPreferences,
          {
        ...
        try {
          await params.client.request(
            hawknextProtocolMethods.workspaceUpdateModelIoPreferences,
            {
              workspace: buildWorkspaceRef(params.workspace),
              preferences: {
  ...
  async function handleProviderReadinessChanged(event: {
    reason: string;
    snapshot: HawkNextAgentProviderReadinessSnapshot;
  }): Promise<void> {
    if (event.snapshot.readiness.ready) {
      await Promise.allSettled(
        Array.from(waitingWorkspaceStartups.entries()).map(async ([workspaceKey, waiting]) => {
          ...
          logger.info(undefined, "provider/model 就绪后已启动等待中的 HawkNext agent", {
  ...
  function getSessionEmitter(params: HawkNextAgentSessionTarget) {
    const key = sessionEventKey(params);
    const existing = sessionEmitters.get(key);
    if (existing) {
      return existing;
    }
    const created = new Emitter<HawkNextAgentServiceEvent>();
  ...
  function getPluginOperationProgressEmitter(operationId: string) {
    ...
    let created: Emitter<HawkNextPluginOperationProgressNotification>;
    created = new Emitter({
  ...
  function getConversationFrameEmitter(workspace: HawkNextAgentWorkspaceTarget) {
  ...
  function getConversationTelemetryFactEmitter(workspace: HawkNextAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getSessionsIndexFrameEmitter(workspace: HawkNextAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function getWorkspaceConfigFrameEmitter(workspace: HawkNextAgentWorkspaceTarget) {
    const key = resolveWorkspaceKey(workspace);
  ...
  function resolveV4Connection(params: unknown, fallbackConnectionId: string = v4ConnectionId) {
    return (
      readTrustedHawkNextAgentV4Connection(params) ?? {
  ...
  function resolveV4UnsubscribeRoute(
    params: HawkNextAgentConversationUnsubscribeParams | HawkNextAgentConversationResyncParams,
    topicPrefix: string,
  ): V4SubscriptionRoute | null {
    const expectedWorkspaceKey = resolveWorkspaceKey(params);
    const trusted = readTrustedHawkNextAgentV4UnsubscribeRoute(params);
    if (trusted) {
  ...
  async function unsubscribeV4Route(
    params: HawkNextAgentConversationUnsubscribeParams,
    topicPrefix: string,
  ): Promise<void> {
  ...
  async function resyncV4Route(params: HawkNextAgentConversationResyncParams, topicPrefix: string) {
    const route = resolveV4UnsubscribeRoute(params, topicPrefix);
  ...
  function emitSessionEvent(
    workspace: HawkNextAgentWorkspaceTarget,
    sessionId: string,
    event: HawkNextAgentServiceEvent,
  ): void {
  ...
  function handleStateUpdated(
    workspace: HawkNextAgentWorkspaceTarget,
    notification: HawkNextStateUpdatedNotification,
  ): void {
  ...
  function wireClient(
    ...
    const disposables = [
      client.onNotification((message) => {
        if (message.method === hawknextProtocolNotifications.providerRuntimeHeadersCancelled) {
          const parsed = hawknextProviderRuntimeHeadersCancelledSchema.safeParse(message.params);
          if (
            !parsed.success ||
        ...
        if (message.method === hawknextProtocolNotifications.processResourceSample) {
          const parsed = hawknextProcessResourceSampleSchema.safeParse(message.params);
          if (parsed.success) {
            processResourceSampleEmitter.fire({ ...parsed.data, lane });
          } else {
            logger.debug(undefined, "丢弃无效 HawkNext CLI 资源样本", {
        ...
        if (message.method === hawknextProtocolNotifications.toolExecResource) {
          const parsed = hawknextToolExecResourceSchema.safeParse(message.params);
          if (parsed.success) toolExecResourceEmitter.fire(parsed.data);
          return;
        }
        if (message.method === hawknextProtocolNotifications.mcpResourceSamples) {
          const parsed = hawknextMcpResourceSamplesSchema.safeParse(message.params);
          if (parsed.success) mcpResourceSamplesEmitter.fire(parsed.data);
          else logger.debug(undefined, "丢弃无效 MCP 资源样本");
          return;
        }

        if (message.method === hawknextProtocolNotifications.mcpTelemetry) {
          const parsed = hawknextMcpTelemetryEventSchema.safeParse(message.params);
          if (parsed.success) {
            mcpTelemetryEmitter.fire(parsed.data);
          } else {
            logger.debug(undefined, "丢弃无效 HawkNext CLI MCP 遥测事件", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                path: issue.path.join("."),
              })),
        ...
        if (message.method === hawknextProtocolNotifications.pluginOperationProgress) {
          const parsed = hawknextPluginOperationProgressNotificationSchema.safeParse(message.params);
          if (parsed.success) {
            pluginOperationProgressEmitters.get(parsed.data.operationId)?.fire(parsed.data);
          } else {
            logger.warn(undefined, "丢弃无效 HawkNext Protocol 插件操作进度", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
        ...
        if (message.method === hawknextProtocolMethods.computerUseOperationEvent) {
          const parsed = hawknextComputerUseOperationEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(undefined, "丢弃无效 HawkNext Protocol Computer Use operation event", {
              issues: parsed.error.issues.map((issue) => ({
                code: issue.code,
                message: issue.message,
                path: issue.path.join("."),
        ...
        if (message.method === "session/event") {
          const parsed = hawknextSessionEventSchema.safeParse(message.params);
          if (parsed.success) {
            ...
            logger.warn(
              ...
              "丢弃无效 HawkNext Protocol session event",
              {
        ...
        if (message.method === "state.updated") {
          const parsed = hawknextStateUpdatedNotificationSchema.safeParse(message.params);
          if (parsed.success) {
      ...
      client.onRequest((request) => {
        if (request.method === hawknextProtocolMethods.sessionRequestRuntimePreferences) {
          ...
          const parsed = hawknextSessionRequestRuntimePreferencesParamsSchema.safeParse(
            request.params,
          );
          if (!parsed.success) {
            void client
          ...
          if (sessionRuntimePreferencesAuthority === "local") {
            void (async () => {
              let preferences: HawkNextSessionRuntimePreferencesResult;
              try {
                preferences = hawknextSessionRuntimePreferencesResultSchema.parse(
          ...
          const dynamicRequest: HawkNextAgentSessionRuntimePreferencesRequest = {
            ...parsed.data,
            requestId,
          };
          ...
          logger.info(undefined, "运行时偏好请求已转发给 Host", {
            event: "hawknext_agent.runtime_preferences.host_request_dispatched",
            module: "services.hawknext_agent",
            requestId,
        ...
        if (request.method === hawknextProtocolMethods.interactionRequestPermission) {
          const parsed = hawknextPermissionRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
        ...
        if (request.method === hawknextProtocolMethods.interactionRequestUserInput) {
          const parsed = hawknextUserInputRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.interactionRequestProviderRuntimeHeaders) {
          const parsed = hawknextProviderRuntimeHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
          ...
          logger.info(request.trace?.traceId, "收到 HawkNext provider runtime headers 请求", {
        ...
        if (request.method === hawknextProtocolMethods.interactionRequestOfficialMcpAuthHeaders) {
          const parsed = hawknextOfficialMcpAuthHeadersRequestParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.interactionBrowserList) {
          const parsed = hawknextBrowserListParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.interactionBrowserExecute) {
          const parsed = hawknextBrowserExecuteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.automationCreate) {
          const parsed = hawknextAutomationCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.offPeakCreate) {
          const parsed = hawknextOffPeakCreateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.offPeakList) {
          const parsed = hawknextOffPeakListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.automationList) {
          const parsed = hawknextAutomationListParamsSchema.safeParse(request.params ?? {});
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.automationCheckTaskBinding) {
          const parsed = hawknextAutomationCheckTaskBindingParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.automationUpdate) {
          const parsed = hawknextAutomationUpdateParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        if (request.method === hawknextProtocolMethods.automationDelete) {
          const parsed = hawknextAutomationDeleteParamsSchema.safeParse(request.params);
          if (!parsed.success) {
            void client.respondError(request.id, {
              code: -32602,
        ...
        void client.respondError(request.id, {
          code: -32601,
          message: `Unsupported HawkNext Protocol request: ${request.method}`,
        });
      }),
      client.onClose(() => {
  ...
  function rememberSessionTrace(
    target: HawkNextAgentSessionTarget,
  ...
  function getSessionTraceId(target: HawkNextAgentSessionTarget): TraceId | undefined {
  ...
  function createProviderNotReadyError(params: {
    ...
    code: typeof HAWKNEXT_AGENT_PROVIDER_NOT_READY_CODE;
    data: {
      providerCount: number;
      reason: typeof HAWKNEXT_AGENT_PROVIDER_NOT_READY_REASON;
    ...
    error.code = HAWKNEXT_AGENT_PROVIDER_NOT_READY_CODE;
    error.data = {
      providerCount: params.snapshot?.providerCount ?? 0,
      reason: HAWKNEXT_AGENT_PROVIDER_NOT_READY_REASON,
  ...
  function isProviderNotReadyError(
    error: unknown,
  ): error is Error & { code: typeof HAWKNEXT_AGENT_PROVIDER_NOT_READY_CODE } {
    return (
      error instanceof Error &&
      (error as { code?: unknown }).code === HAWKNEXT_AGENT_PROVIDER_NOT_READY_CODE
    );
  }

  async function resolveStartupReadiness(): Promise<
    HawkNextAgentProviderReadinessSnapshot | undefined
  > {
  ...
  function isReusableActiveClientEntry(
    params: HawkNextAgentWorkspaceTarget,
    ...
    activeClientsByWorkspaceKey.delete(workspaceKey);
    interactionPreferenceSyncByWorkspaceKey.delete(workspaceKey);
    logger.warn(undefined, "复用的 HawkNext Protocol client 已 disposed，清理 stale entry", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return false;
  ...
  async function getOrStartReadOnlyClient(
    ...
    const interactionPreferencesReady = (async () => {
      let appliedSnapshot: HawkNextAgentAppRuntimePreferences | undefined;
    ...
    const offPeakToolPolicyReady = (async () => {
      ...
      try {
        await client.request(
          hawknextProtocolMethods.workspaceUpdateOffPeakToolPolicy,
    ...
    const dynamicWorkflowPolicyReady = (async () => {
      ...
      try {
        await client.request(
          hawknextProtocolMethods.workspaceUpdateDynamicWorkflowPolicy,
          { workspace: buildWorkspaceRef(params), enabled: true },
          hawknextWorkspaceUpdateDynamicWorkflowPolicyResultSchema,
        );
      } catch (error) {
    ...
    logger.info(undefined, "为只读会话控制面启动 HawkNext agent", {
      workspaceKey,
      workspacePath: params.workspacePath,
    });
    return entry;
  ...
  async function getClient(params: HawkNextAgentWorkspaceTarget) {
    const workspaceKey = resolveWorkspaceKey(params);
    const active = activeClientsByWorkspaceKey.get(workspaceKey);
    ...
    if (!readinessSnapshot || !readiness?.ready) {
      ...
      if (waiting.lastLoggedRevision !== revision) {
        ...
        logger.info(
          undefined,
          active
            ? "provider/model 尚未就绪，HawkNext agent 保持只读"
            : "provider/model 尚未就绪，HawkNext agent 保持未启动",
          {
    ...
    waitingWorkspaceStartups.delete(workspaceKey);
    logger.info(undefined, "provider/model 就绪，允许 HawkNext agent 模型执行", {
  ...
  async function getPluginManagementClient(): Promise<HawkNextProtocolClient> {
  ...
  // homedir() 即用户家目录，全局根 `~/.hawknext/workflows/` 因此解析到真实目录。
  // 远程 runtime（SSH/WSL identity 或带 remoteSessionId）的 home 不是本机，绝不选它当载体。
  function isLocalActiveWorkspaceClient(workspace: HawkNextAgentWorkspaceTarget): boolean {
    return (
      !workspace.remoteSessionId &&
      !(workspace.workspaceIdentity && isRemoteWorkspaceIdentity(workspace.workspaceIdentity))
    );
  ...
  async function resolveGlobalSavedWorkflowCarrier(): Promise<{
    client: HawkNextProtocolClient;
    workspace: HawkNextWorkspaceRef;
  }> {
  ...
  async function resolveSavedWorkflowCarrier(
    params: HawkNextAgentSavedWorkflowTarget,
  ): Promise<{ client: HawkNextProtocolClient; workspace: HawkNextWorkspaceRef }> {
  ...
  async function getMcpStatusClient(): Promise<HawkNextProtocolClient> {
    const workspace = { workspacePath: ensurePluginManagementWorkspacePath() };
  ...
  async function buildConversationCommandEnvelope(
    params: HawkNextAgentConversationCommandParams,
  ...
  return {
    ...
    async initialize(params: HawkNextAgentWorkspaceTarget): Promise<HawkNextAgentInitializeResult> {
      const workspaceKey = resolveWorkspaceKey(params);
      const startedAt = Date.now();
      logger.info(undefined, "开始初始化 HawkNext agent", {
        workspaceKey,
        workspacePath: params.workspacePath,
      });
      try {
        const client = await getClient(params);
        logger.info(undefined, "HawkNext agent 初始化完成", {
        ...
        return {
          available: true,
          workspaceKey,
          protocolName: HAWKNEXT_PROTOCOL_NAME,
          protocolVersion: HAWKNEXT_PROTOCOL_VERSION,
          transportKind: client.transportKind === "websocket" ? "websocket" : "stdio",
        };
      } catch (error) {
        ...
        logger[providerNotReady ? "info" : "warn"](
          undefined,
          providerNotReady ? "HawkNext agent 等待 provider/model 就绪" : "HawkNext agent 初始化失败",
          {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            workspaceKey,
        ...
        return {
          ...
          ...(providerNotReady ? { reasonCode: HAWKNEXT_AGENT_PROVIDER_NOT_READY_REASON } : {}),
        };
      }
    },

    async syncAppRuntimePreferences(preferences: HawkNextAgentAppRuntimePreferences): Promise<void> {
      const normalizedPreferences: HawkNextAgentAppRuntimePreferences = {
        ...preferences,
    ...
    async getWorkspaceRuntimeIdentity(params: HawkNextAgentWorkspaceTarget) {
    ...
    async createSession(params: HawkNextAgentCreateSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      logger.info(sessionTraceId, "开始请求 HawkNext Protocol session/create", {
      ...
      try {
        const snapshot = await client.request(
          hawknextProtocolMethods.sessionCreate,
        ...
        logger.info(sessionTraceId, "HawkNext Protocol session/create 完成", {
          durationMs: Date.now() - startedAt,
        ...
        if (compatFields.length === 0) {
          logger.warn(sessionTraceId, "HawkNext Protocol session/create 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            persistence: params.persistence,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId, "HawkNext Protocol session/create 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
        ...
        if (!compatFields.includes("thoughtLevel") || !params.thoughtLevel) {
          logger.info(sessionTraceId, "HawkNext Protocol session/create 兼容重试完成", {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
            snapshotTraceId: snapshot.session.traceId ?? null,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        const snapshotWithThoughtLevel = await client.request(
          hawknextProtocolMethods.sessionSetThoughtLevel,
          {
            sessionId: snapshot.session.sessionId,
            thoughtLevel: params.thoughtLevel,
        ...
        logger.info(
          sessionTraceId,
          "HawkNext Protocol session/create 兼容重试后设置 thoughtLevel 完成",
          {
            durationMs: Date.now() - startedAt,
            sessionId: snapshot.session.sessionId,
    ...
    async resumeSession(params: HawkNextAgentResumeSessionParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      const dynamicWorkflowEnabled = await resolveDynamicWorkflowGate();
      logger.info(cachedTraceId, "开始请求 HawkNext Protocol session/resume", {
        mcpServerCount: getMcpServerCount(params),
        mcpServerNames: getMcpServerNames(params),
      ...
      try {
        const snapshot = await client.request(
          hawknextProtocolMethods.sessionResume,
        ...
        logger.info(sessionTraceId, "HawkNext Protocol session/resume 完成", {
          durationMs: Date.now() - startedAt,
          messageCount: snapshot.messages.length,
          modelCurrent: formatModelSelectionForLog(snapshot.settings.model.current),
          mcpServerCount: getMcpServerCount(params),
        ...
        if (compatFields.length === 0) {
          logger.warn(cachedTraceId, "HawkNext Protocol session/resume 失败", {
            durationMs: Date.now() - startedAt,
            message: error instanceof Error ? error.message : String(error),
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(cachedTraceId, "HawkNext Protocol session/resume 命中新旧协议兼容重试", {
          compatFields,
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        const sessionTraceId = rememberSessionTrace(params, snapshot) ?? cachedTraceId;
        logger.info(sessionTraceId, "HawkNext Protocol session/resume 兼容重试完成", {
          durationMs: Date.now() - startedAt,
          sessionId: params.sessionId,
          snapshotTraceId: snapshot.session.traceId ?? null,
          workspaceKey: resolveWorkspaceKey(params),
    ...
    async listSessions(params: HawkNextAgentListSessionsParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const result = await client.request(
        hawknextProtocolMethods.sessionList,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async listSessionSubagents(params: HawkNextAgentListSessionSubagentsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        hawknextProtocolMethods.sessionSubagents,
        {
          sessionId: params.sessionId,
    ...
    async getAppUsageStats(params: HawkNextAgentAppUsageParams) {
    ...
    async getTaskTokenUsage(params: HawkNextAgentTaskTokenUsageParams) {
      const client = await getReadOnlyClient(params);
    ...
    async readSession(params: HawkNextAgentReadSessionParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      ...
      const snapshot = await client.request(
        hawknextProtocolMethods.sessionRead,
        {
          sessionId: params.sessionId,
    ...
    async readSessionMessages(params: HawkNextAgentReadSessionMessagesParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        hawknextProtocolMethods.sessionMessages,
        {
          sessionId: params.sessionId,
    ...
    async readSessionDebug(params) {
      ...
      return client.request(
        hawknextProtocolMethods.sessionDebug,
        { sessionId: params.sessionId },
        sessionDebugSnapshotSchema,
      );
    },

    async readSessionEvents(params: HawkNextAgentReadSessionEventsParams) {
      const client = await getReadOnlyClient(params);
      const result = await client.request(
        hawknextProtocolMethods.sessionEvents,
        {
          sessionId: params.sessionId,
          afterSeq: params.afterSeq,
          limit: params.limit,
    ...
    async readWorkspacePresentation(params: HawkNextAgentReadWorkspacePresentationParams) {
      const startedAt = Date.now();
      logger.info(undefined, "开始请求 HawkNext Protocol workspace/readPresentation", {
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      });
      try {
        let presentation: HawkNextWorkspacePresentation | undefined;
        for (let attempt = 0; attempt < 2; attempt += 1) {
          ...
          try {
            ...
            presentation = await client.request(
              hawknextProtocolMethods.workspaceReadPresentation,
              { workspace: buildWorkspaceRef(params) },
              hawknextWorkspacePresentationSchema,
            );
            break;
        ...
        if (!presentation) {
          throw new Error("HawkNext Protocol workspace/readPresentation did not return a result");
        }
        logger.info(undefined, "HawkNext Protocol workspace/readPresentation 完成", {
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(undefined, "HawkNext Protocol workspace/readPresentation 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          workspaceKey: resolveWorkspaceKey(params),
          workspacePath: params.workspacePath,
    ...
    async grantWorkspaceHookTrust(params: HawkNextAgentGrantWorkspaceHookTrustParams) {
    ...
    async listMcpServerStatuses(params: HawkNextAgentListMcpServerStatusesParams) {
      ...
      try {
        ...
        if (params.mode === "status" && unrecognizedKeys.includes("mode")) {
          ...
          throw new HawkNextAgentMcpStatusModeUnsupportedError();
        }
        if (
        ...
        if (!isProtocolRequestTimeout(error, hawknextProtocolMethods.mcpList)) {
          throw error;
        }
    ...
    async listPlugins(params: HawkNextAgentPluginViewParams) {
      const requestPluginsList = async () => {
        ...
        return client.request(
          hawknextProtocolMethods.pluginsList,
          {
            workspace: buildWorkspaceRef(params),
      ...
      try {
        ...
        if (!isProtocolRequestTimeout(error, hawknextProtocolMethods.pluginsList)) {
          throw error;
        }
    ...
    async getPluginReferenceCatalog(params: HawkNextAgentPluginReferenceCatalogParams) {
    ...
    async getSkillReferenceCatalog(params: HawkNextAgentSkillReferenceCatalogParams) {
      // 与 Plugin 引用一样，Session 快照只存在于 workspace agent 进程；独立管理进程
      // 没有 resident Session，不能作为对话 authority。
      const client = await getReadOnlyClient(params);
      return client.request(
        hawknextProtocolMethods.skillsReferenceCatalog,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.sessionId ? { sessionId: params.sessionId } : {}),
        },
    ...
    // `scope` 只在有定义时下推。
    async listSavedWorkflows(params: HawkNextAgentListSavedWorkflowsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        hawknextProtocolMethods.workflowsList,
        { workspace, ...savedWorkflowScopeParam(params) },
        hawknextWorkflowsListResultSchema,
      );
    },

    async getSavedWorkflow(params: HawkNextAgentGetSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        hawknextProtocolMethods.workflowsGet,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        hawknextWorkflowsGetResultSchema,
      );
    },

    async updateSavedWorkflowMeta(params: HawkNextAgentUpdateSavedWorkflowMetaParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        hawknextProtocolMethods.workflowsUpdateMeta,
        { workspace, name: params.name, meta: params.meta, ...savedWorkflowScopeParam(params) },
        hawknextWorkflowsUpdateMetaResultSchema,
      );
    },

    async deleteSavedWorkflow(params: HawkNextAgentDeleteSavedWorkflowParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        hawknextProtocolMethods.workflowsDelete,
        { workspace, name: params.name, ...savedWorkflowScopeParam(params) },
        hawknextWorkflowsDeleteResultSchema,
      );
    },

    async listSavedWorkflowRuns(params: HawkNextAgentListSavedWorkflowRunsParams) {
      const { client, workspace } = await resolveSavedWorkflowCarrier(params);
      return client.request(
        hawknextProtocolMethods.workflowsRuns,
        {
          workspace,
    ...
    async moveSavedWorkflow(params: HawkNextAgentMoveSavedWorkflowParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
        hawknextProtocolMethods.workflowsMove,
        { workspace: buildWorkspaceRef(params), name: params.name },
        hawknextWorkflowsMoveResultSchema,
      );
    },

    async resolveSuggestedPluginReference(params: HawkNextAgentResolveSuggestedPluginReferenceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsResolveSuggestedReference,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async collectLocalRuntimeChildProcesses(signal?: AbortSignal) {
      ...
      return Promise.all(
        managed.map(async (runtime) => {
          let children: HawkNextProcessChildProcess[] = [];
          try {
            const result = await runtime.client.request(
              hawknextProtocolMethods.processChildProcesses,
              {},
              hawknextProcessChildProcessesResultSchema,
    ...
    async getPluginsOverview(params: HawkNextAgentPluginViewParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsOverview,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.configScope ? { configScope: params.configScope } : {}),
        },
    ...
    async addPluginMarketplace(params: HawkNextAgentAddPluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsMarketplaceAdd,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async removePluginMarketplace(params: HawkNextAgentRemovePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsMarketplaceRemove,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePluginMarketplace(params: HawkNextAgentUpdatePluginMarketplaceParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsMarketplaceUpdate,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async installPlugin(params: HawkNextAgentInstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsInstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async cancelPluginOperation(params: HawkNextAgentCancelPluginOperationParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsCancelOperation,
        { operationId: params.operationId },
        hawknextPluginsCancelOperationResultSchema,
    ...
    async uninstallPlugin(params: HawkNextAgentUninstallPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsUninstall,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async updatePlugin(params: HawkNextAgentUpdatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsUpdate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginId ? { pluginId: params.pluginId } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async restoreBuiltinPlugin(params: HawkNextAgentRestoreBuiltinPluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsRestoreBuiltin,
        {
          workspace: buildWorkspaceRef(params),
    ...
    async configurePlugin(params: HawkNextAgentConfigurePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsConfigure,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async resetPluginConfig(params: HawkNextAgentResetPluginConfigParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsResetConfig,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
          ...(params.scope ? { scope: params.scope } : {}),
    ...
    async validatePlugin(params: HawkNextAgentValidatePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsValidate,
        {
          workspace: buildWorkspaceRef(params),
          ...(params.pluginName ? { pluginName: params.pluginName } : {}),
          ...(params.marketplace ? { marketplace: params.marketplace } : {}),
    ...
    async describePlugin(params: HawkNextAgentDescribePluginParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsDescribe,
        {
          workspace: buildWorkspaceRef(params),
          marketplace: params.marketplace,
          pluginName: params.pluginName,
    ...
    async setPluginEnabled(params: HawkNextAgentSetPluginEnabledParams) {
      const client = await getPluginManagementClient();
      return client.request(
        hawknextProtocolMethods.pluginsSetEnabled,
        {
          workspace: buildWorkspaceRef(params),
          pluginId: params.pluginId,
    ...
    async listAutomations(params: HawkNextAgentWorkspaceTarget) {
    ...
    async createAutomation(params: HawkNextAgentCreateAutomationParams) {
      return automationService.create({
        ...
        mode: params.mode as HawkNextTaskMode | undefined,
        workspacePath: params.workspacePath,
        workspaceIdentity: params.workspaceIdentity,
    ...
    async updateAutomation(params: HawkNextAgentUpdateAutomationParams) {
      return automationService.update(
        params.automationId,
        {
          ...
          prompt: params.prompt,
          modelSelection: params.modelSelection,
          mode: params.mode === null ? null : (params.mode as HawkNextTaskMode | undefined),
    ...
    async deleteAutomation(params: HawkNextAgentAutomationIdParams) {
    ...
    async setAutomationEnabled(params: HawkNextAgentSetAutomationEnabledParams) {
    ...
    async restartAutomation(params: HawkNextAgentAutomationIdParams) {
    ...
    async runAutomationNow(params: HawkNextAgentAutomationIdParams) {
    ...
    async listAutomationRuns(params: HawkNextAgentAutomationIdParams) {
    ...
    async deleteAutomationRun(params: HawkNextAgentDeleteAutomationRunParams) {
    ...
    async generateWorkspaceText(params: HawkNextAgentGenerateWorkspaceTextParams) {
      const client = await getClient(params);
      // Worker 自己读取 HawkNext Built-in / Personal Config；Host 只在执行前确保账号状态形成的
      ...
      const cancel = () => {
        ...
        void client
          .request(
            hawknextProtocolMethods.workspaceCancelGenerateText,
            { operationId },
            hawknextWorkspaceCancelGenerateTextResultSchema,
            { timeoutMs: 5_000 },
          )
      ...
      try {
        return await client.request(
          hawknextProtocolMethods.workspaceGenerateText,
          {
            workspace: buildWorkspaceRef(params),
    ...
    async testModelConnectivity(params: HawkNextAgentTestModelConnectivityParams) {
      const client = await getClient(params);
      await ensureAccountProviderConfigSynced({
        client,
      ...
      return client.request(
        hawknextProtocolMethods.providerTestModelConnectivity,
        {
          workspace: buildWorkspaceRef(params),
          selection: params.selection,
        },
    ...
    async sendPrompt(params: HawkNextAgentSendPromptParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      ...
      const protocolParams: HawkNextAgentSendPromptParams = {
        ...params,
        ...(browserAmbientContext ? { browserAmbientContext } : {}),
      };
      logger.info(logTraceId, "HawkNext Agent session/send 开始", {
      ...
      try {
        const result = await client.request(
          hawknextProtocolMethods.sessionSend,
          buildSessionSendParams(protocolParams),
          hawknextSessionSendResultSchema,
        );
        logger.info(logTraceId, "HawkNext Agent session/send ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          queryId: params.queryId ?? null,
          sessionId: params.sessionId,
        ...
        if (compatFields.length > 0) {
          logger.warn(logTraceId, "HawkNext Agent session/send 命中新旧协议兼容重试", {
            compatFields,
            durationMs: Date.now() - startedAt,
            sessionId: params.sessionId,
            workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(logTraceId, "HawkNext Agent session/send 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          queryId: params.queryId ?? null,
    ...
    async compactSession(params: HawkNextAgentCompactParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      const sessionTraceId = getSessionTraceId(params);
      logger.info(sessionTraceId ?? params.inputId, "HawkNext Protocol session/compact 开始", {
        inputId: params.inputId,
        sessionId: params.sessionId,
        workspaceKey: resolveWorkspaceKey(params),
        workspacePath: params.workspacePath,
      ...
      try {
        const result = await client.request(
          hawknextProtocolMethods.sessionCompact,
        ...
        logger.info(sessionTraceId ?? params.inputId, "HawkNext Protocol session/compact ACK", {
          durationMs: Date.now() - startedAt,
          inputId: params.inputId,
          sessionId: params.sessionId,
          workspaceKey: resolveWorkspaceKey(params),
        ...
        logger.warn(sessionTraceId ?? params.inputId, "HawkNext Protocol session/compact 失败", {
          durationMs: Date.now() - startedAt,
          error: error instanceof Error ? error.message : String(error),
          inputId: params.inputId,
          sessionId: params.sessionId,
    ...
    async goalSession(params: HawkNextAgentGoalParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(params.inputId, "开始请求 HawkNext Protocol session/goal", {
      ...
      try {
        const result = await client.request(
          hawknextProtocolMethods.sessionGoal,
          {
            sessionId: params.sessionId,
            inputId: params.inputId,
            action: params.action,
        ...
        logger.info(params.inputId, "HawkNext Protocol session/goal 完成", {
          action: params.action,
          durationMs: Date.now() - startedAt,
        ...
        logger.warn(params.inputId, "HawkNext Protocol session/goal 失败", {
          action: params.action,
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          sessionId: params.sessionId,
    ...
    async closeSession(
      params: HawkNextAgentSessionTarget & {
        expectedPersistence?: "deferred" | "immediate";
      },
    ): Promise<boolean> {
      const client = await getClient(params);
      const result = await client.request(
        hawknextProtocolMethods.sessionClose,
        {
          sessionId: params.sessionId,
    ...
    async setModel(params: HawkNextAgentSetModelParams) {
      const startedAt = Date.now();
      const client = await getClient(params);
      logger.info(undefined, "开始请求 HawkNext Protocol session/setModel", {
      ...
      try {
        const snapshot = await client.request(
          hawknextProtocolMethods.sessionSetModel,
          {
            sessionId: params.sessionId,
            model: params.model,
            expectedRevision: params.expectedRevision,
        ...
        logger.info(undefined, "HawkNext Protocol session/setModel 完成", {
          durationMs: Date.now() - startedAt,
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
        ...
        logger.warn(undefined, "HawkNext Protocol session/setModel 失败", {
          durationMs: Date.now() - startedAt,
          message: error instanceof Error ? error.message : String(error),
          requestedModel: formatModelSelectionForLog(params.model),
          sessionId: params.sessionId,
    ...
    async setThoughtLevel(params: HawkNextAgentSetThoughtLevelParams) {
      const client = await getClient(params);
      const snapshot = await client.request(
        hawknextProtocolMethods.sessionSetThoughtLevel,
        {
    ...
    async setMode(params: HawkNextAgentSetModeParams) {
      const client = await getClient(params);
      return client.request(
        hawknextProtocolMethods.sessionSetMode,
        {
          sessionId: params.sessionId,
          mode: params.mode,
          expectedRevision: params.expectedRevision,
    ...
    async respondSessionRuntimePreferences(
      params: HawkNextAgentRespondSessionRuntimePreferencesParams,
    ): Promise<void> {
      const pending = takePendingSessionRuntimePreferences(params.requestId);
      if (!pending) {
        logger.warn(undefined, "运行时偏好响应找不到 pending 请求", {
          event: "hawknext_agent.runtime_preferences.response_without_pending",
          module: "services.hawknext_agent",
          requestId: params.requestId,
        });
        throw new Error(`HawkNext session runtime preferences request not found: ${params.requestId}`);
      }
      const responseContext = {
        event: "hawknext_agent.runtime_preferences.host_response_received",
        module: "services.hawknext_agent",
        requestId: params.requestId,
        scope: pending.request.scope,
        sessionId: pending.request.sessionId,
    ...
    onDynamicSessionEvent(params: HawkNextAgentSessionSubscribeParams) {
      ...
      return (listener) => {
        ...
        const pendingLiveEvents: HawkNextAgentServiceEvent[] = [];
        ...
        const deliverToListener = (event: HawkNextAgentServiceEvent): void => {
          if (cancelled) {
            return;
          }
        ...
        const establishSubscription = async (attempt: number): Promise<void> => {
          ...
          try {
            ...
            const result = await client.request(
              hawknextProtocolMethods.sessionSubscribe,
              {
                sessionId: params.sessionId,
                deliveryKind: params.deliveryKind,
                afterSeq: params.afterSeq,
            ...
            if (attempt >= SESSION_SUBSCRIBE_MAX_ATTEMPTS - 1) {
              ...
              console.warn(
                formatLogPrefix("hawknext-agent", process.pid),
    ...
    async setConnectionFlowStateV4(params: HawkNextAgentConnectionFlowParams) {
      const trusted = readTrustedHawkNextAgentV4Connection(params);
    ...
    async subscribeConversationV4(params: HawkNextAgentConversationSubscribeParams) {
      ...
      // Account Config 顺序屏障，不提升模型执行权限。HawkNext Built-in / Personal 仍由 Worker 维护。
    ...
    async unsubscribeConversationV4(params: HawkNextAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "conversation/");
    },

    async resyncConversationV4(params: HawkNextAgentConversationResyncParams) {
      return resyncV4Route(params, "conversation/");
    },

    async sendConversationCommandV4(params: HawkNextAgentConversationCommandParams) {
      const client = await getClient(params);
      ...
      const commandClientMode =
        readTrustedHawkNextAgentV4Connection(params)?.clientMode ??
        params.clientMode ??
        "desktop-continuous";
      if (params.envelope.type === "createSession") {
        // V4 草稿预热直接走 command 转发；新会话创建前只需等待 Account Config，
        // HawkNext Built-in / Personal 已由 Worker 进程 Registry 自己装配。
        await ensureAccountProviderConfigSynced({
          client,
    ...
    async queryConversationCommandsV4(params: HawkNextAgentCommandsQueryParams) {
      if (!readTrustedHawkNextAgentV4Connection(params)) {
    ...
    async attachmentBeginV4(params: HawkNextAgentAttachmentBeginParams) {
      const trusted = readTrustedHawkNextAgentV4Connection(params);
    ...
    async attachmentChunkV4(params: HawkNextAgentAttachmentChunkParams) {
      const trusted = readTrustedHawkNextAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentCommitV4(params: HawkNextAgentAttachmentTerminalParams) {
      const trusted = readTrustedHawkNextAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentAbortV4(params: HawkNextAgentAttachmentTerminalParams) {
      const trusted = readTrustedHawkNextAgentV4Connection(params);
      if (!trusted) throw new Error("fault.attachment.connectionUntrusted");
      const client = await getClient(params);
      const wireParams = {
    ...
    async attachmentReadV4(params: HawkNextAgentAttachmentReadParams) {
      if (!readTrustedHawkNextAgentV4Connection(params)) {
    ...
    async conversationAttachmentReadV4(params: HawkNextAgentConversationAttachmentReadParams) {
      if (!readTrustedHawkNextAgentV4Connection(params)) {
        throw new HawkNextAttachmentFaultError(
          HAWKNEXT_ATTACHMENT_FAULT_CODES.shareReadConnectionUntrusted,
        );
      }
    ...
    async conversationAttachmentStatV4(params: HawkNextAgentConversationAttachmentStatParams) {
      if (!readTrustedHawkNextAgentV4Connection(params)) {
        throw new HawkNextAttachmentFaultError(
          HAWKNEXT_ATTACHMENT_FAULT_CODES.shareStatConnectionUntrusted,
        );
      }
    ...
    async attachmentPreviewSourceV4(params: HawkNextAgentAttachmentPreviewSourceParams) {
      const trusted = readTrustedHawkNextAgentV4Connection(params);
    ...
    async conversationRowsRangeV4(params: HawkNextAgentConversationRowsRangeParams) {
      const trusted = readTrustedHawkNextAgentV4Connection(params);
    ...
    async conversationPlansV4(params: HawkNextAgentConversationPlansParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunEventsV4(params: HawkNextAgentConversationWorkflowRunEventsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunsV4(params: HawkNextAgentConversationWorkflowRunsParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunArtifactsV4(
      params: HawkNextAgentConversationWorkflowRunArtifactsParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunArtifactDataV4(
      params: HawkNextAgentConversationWorkflowRunArtifactDataParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunArtifactReadV4(
      params: HawkNextAgentConversationWorkflowRunArtifactReadParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunWorkspaceV4(
      params: HawkNextAgentConversationWorkflowRunWorkspaceParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationWorkflowRunNodeResultV4(
      params: HawkNextAgentConversationWorkflowRunNodeResultParams,
    ) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async backgroundBashOutputV4(params: HawkNextAgentBackgroundBashOutputParams) {
      if (!readTrustedHawkNextAgentV4Connection(params))
    ...
    async conversationFileChangesV4(params: HawkNextAgentConversationFileChangesParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    async conversationFileRewindPreviewV4(params: HawkNextAgentConversationFileRewindPreviewParams) {
      const client = await getReadOnlyClient(params);
      return client.request(
    ...
    onDynamicConversationFrame(params: HawkNextAgentWorkspaceTarget) {
      return getConversationFrameEmitter(params).event;
    },

    onDynamicLocalTtftFacts(params: HawkNextAgentWorkspaceTarget) {
    ...
    onDynamicConversationTelemetryFact(params: HawkNextAgentWorkspaceTarget) {
    ...
    async subscribeSessionsIndexV4(params: HawkNextAgentSessionsIndexSubscribeParams) {
    ...
    async unsubscribeSessionsIndexV4(params: HawkNextAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "sessions-index/");
    },

    async resyncSessionsIndexV4(params: HawkNextAgentConversationResyncParams) {
      return resyncV4Route(params, "sessions-index/");
    },

    onDynamicSessionsIndexFrame(params: HawkNextAgentWorkspaceTarget) {
    ...
    async subscribeWorkspaceConfigV4(params: HawkNextAgentWorkspaceConfigSubscribeParams) {
      const client = await getReadOnlyClient(params, params.runtimePolicy);
      const connection = resolveV4Connection(params, v4ConnectionIdFor(params.subscriberScope));
    ...
    async unsubscribeWorkspaceConfigV4(params: HawkNextAgentConversationUnsubscribeParams) {
      await unsubscribeV4Route(params, "workspace-config/");
    },

    async resyncWorkspaceConfigV4(params: HawkNextAgentConversationResyncParams) {
      return resyncV4Route(params, "workspace-config/");
    },

    onDynamicWorkspaceConfigFrame(params: HawkNextAgentWorkspaceTarget) {
    ...
    onAgentRuntimeLifecycle(listener: (event: HawkNextAgentRuntimeLifecycleEvent) => void) {
