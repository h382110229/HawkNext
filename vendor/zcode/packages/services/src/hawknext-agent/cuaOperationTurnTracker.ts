import { resolveWorkspaceKey, type HawkNextComputerUseOperationEvent } from "@hawknext/shared";
...
interface CuaOperationTurnTracker {
  accept(workspace: CuaOperationWorkspaceTarget, event: HawkNextComputerUseOperationEvent): void;
...
export function createCuaOperationTurnTracker(options: {
  ...
  function accept(
    workspace: CuaOperationWorkspaceTarget,
    event: HawkNextComputerUseOperationEvent,
  ): void {
