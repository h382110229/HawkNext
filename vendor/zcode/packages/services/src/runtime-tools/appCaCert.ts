...
const APP_CA_CERT_FILE = "hawknext-network-ca.pem";
const APP_CA_KEY_FILE = "hawknext-network-ca.key";
...
function generateSelfSignedCa(): { certPem: string; keyPem: string } {
  ...
  const attrs = [
    { name: "commonName", value: "HawkNext Network CA" },
    { name: "organizationName", value: "HawkNext" },
  ];
