...
import type { ResourceUsageSnapshot, StorageManagementBridge } from "@hawknext/shared";
...
function applyResourceManagerTheme(): void {
  const savedTheme = (localStorage.getItem("hawknext-theme") as Theme | null) ?? "zai-dark";
