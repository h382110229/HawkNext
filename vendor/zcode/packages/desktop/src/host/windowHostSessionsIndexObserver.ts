...
import { HAWKNEXT_AGENT_RUNTIME_UNAVAILABLE_CODE, type IHawkNextAgentService } from "@hawknext/services";
import {
  PROTOCOL_V4_LIMITS,
  sessionsIndexTopic,
...
> &
  Partial<Pick<IHawkNextAgentService, "onAgentRuntimeLifecycle">>;
