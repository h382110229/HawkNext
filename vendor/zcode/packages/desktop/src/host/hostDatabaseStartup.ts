import {
  ...
  resolveHawkNextAgentSpawnCwd,
} from "@hawknext/services/storage-startup";
import type { DatabaseStartupState } from "@hawknext/shared";
    ...
    prepare: async (report) => {
      ...
      try {
        ...
        for (const candidate of candidates) {
          ...
          const { cwd } = await resolveHawkNextAgentSpawnCwd({
