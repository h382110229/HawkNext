...
import type { HawkNextArchivedTaskDeletionResult } from "@hawknext/services";
import {
...
export interface WindowHostControllerSessionOverlay {
  ...
  updatedAt?: number;
  pendingInteraction?: HawkNextTaskMeta["pendingInteraction"];
...
export type WindowHostControllerMutationResult = void | boolean | HawkNextArchivedTaskDeletionResult;
...
function defaultLiveStatus(meta: HawkNextTaskMeta): WindowHostControllerTaskRow["liveStatus"] {
