...
import type { IFileService, IMediaPreviewService, MediaPreviewPreparation } from "@hawknext/services";
import { getMediaPreviewFormat, type WindowHostAttachmentScope } from "@hawknext/shared";
import {
...
const MEDIA_ROUTE_PREFIX = "/__hawknext_media/";
