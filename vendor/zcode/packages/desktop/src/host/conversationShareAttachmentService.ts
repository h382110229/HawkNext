import { Event as RpcEvent } from "@hawknext/rpc";
import type { IConversationShareService, IHawkNextAgentService } from "@hawknext/services";
import { conversationShareConnectionScopeFactory } from "@hawknext/services/node";
