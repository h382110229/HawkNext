import { type HawkNextRuntimeEnv } from "@hawknext/shared";
...
export declare function buildArmsBrowserInitConfig(runtimeEnv: HawkNextRuntimeEnv): {
  enable: boolean;
  version: string;
  endpoint: string;
  env: import("@hawknext/shared").ArmsRumEnv;
  sessionConfig: {
    sampleRate: number;
  };
  spaMode: false;
