...
import { HELPER_APP_NAME } from "@hawknext/hawknext-cua/broker/helperConstants";
import {
...
export { normalizeCuaHelperArch, normalizeCuaHelperArchs } from "@hawknext/services/node";
...
export function createDesktopCuaHelperInstaller(
  ...
  if (bundledAppPath) {
    delete env.HAWKNEXT_CUA_HELPER_ALLOW_UNSIGNED_LOCAL;
  }
