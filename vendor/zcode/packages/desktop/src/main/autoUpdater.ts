...
import type { ISettingService } from "@hawknext/services";
import {
  DEFAULT_LOCALE,
...
const UPDATE_FEED_URL_ENV = "HAWKNEXT_UPDATE_FEED_URL";
const UPDATE_FEED_URL_SWITCH = "--hawknext-update-feed-url";
const DEV_AUTO_UPDATE_ENV = "HAWKNEXT_AUTO_UPDATE_DEV";
const DEV_AUTO_UPDATE_SWITCH = "--hawknext-auto-update-dev";
const DEV_AUTO_UPDATE_VERSION_ENV = "HAWKNEXT_AUTO_UPDATE_DEV_VERSION";
const DEV_AUTO_UPDATE_VERSION_SWITCH = "--hawknext-auto-update-dev-version";
...
type UpdateDownloadedInfoLike = {
  ...
  hawknextReleaseChannel?: ElectronReleaseChannel | null;
...
function readUpdateInfoReleaseChannel(
  ...
  return info.hawknextReleaseChannel === "preview" || info.hawknextReleaseChannel === "stable"
    ? info.hawknextReleaseChannel
    : null;
}
...
function applyManifestUpdateProvider(options: InitAutoUpdaterOptions): void {
  ...
  autoUpdater.setFeedURL({
    ...
    resolveEndpointOrigin:
      options.resolveEndpointOrigin ?? (() => resolveRuntimeHawkNextEndpointOrigin(process.env)),
