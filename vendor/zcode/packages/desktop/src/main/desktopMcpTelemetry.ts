...
export function reportMcpTelemetryToArms(
  event: HawkNextMcpTelemetryEvent,
...
function mapMcpTelemetryEvent(event: Exclude<HawkNextMcpTelemetryEvent, { kind: "memory" }>): {
...
function processProperties(
  event: Extract<HawkNextMcpTelemetryEvent, { kind: "process_start" | "process_crash" }>,
