...
function buildLegacyCommonMcpStorageCandidates(request?: MigrateLegacyCommonMcpRequest): string[] {
  ...
  candidates.push(join(appData, "ai.z.hawknext", "store.json"));

  candidates.push(
    join(localAppData, "ai.z.work", "EBWebView", "Default", "Local Storage", "leveldb"),
    join(appData, "HawkNext", "Local Storage", "leveldb"),
    join(appData, "HawkNext", "Partitions", "hawknext-embedded-browser", "Local Storage", "leveldb"),
    join(appData, "HawkNext Dev", "Local Storage", "leveldb"),
    join(appData, "HawkNext Dev", "Partitions", "hawknext-embedded-browser", "Local Storage", "leveldb"),
  );
