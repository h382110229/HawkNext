...
const WORKFLOW_NAME = "Open in HawkNext.workflow";
const WORKFLOW_BUNDLE_ID = "dev.hawknext.app.finder-open-workflow";
const WORKFLOW_VERSION = "5";
const SERVICES_MENU_LABELS: Record<Locale, string> = {
  "zh-CN": "在HawkNext中打开",
  "en-US": "Open in HawkNext",
};
...
if [ -n "$first" ]; then
  ...
  /usr/bin/open "hawknext://workspace/open?path=\${encoded}"
fi
`;
