...
import type { ApplicationIconInfo } from "@hawknext/shared";
...
public static class HawkNextAumidIcon {
...
'@;
$hawknextIconBytes=[HawkNextAumidIcon]::Read($hawknextArg0);
[Console]::Out.Write([Convert]::ToBase64String($hawknextIconBytes));
`;
