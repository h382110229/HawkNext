...
import type { BrowserPlaywrightAction, BrowserPlaywrightModifier } from "@hawknext/shared";
...
const PLAYWRIGHT_WORLD_NAME = "hawknext-playwright-locator";
const PLAYWRIGHT_GLOBAL = "__hawknextPlaywrightInjected";
      ...
      try {
        probeExecution = await this.actionProbe(
          target,
          {
            ...
            //  输入框的持续动画会让 stable 永不成立，等待 stable 会卡到 MCP hard timeout。
