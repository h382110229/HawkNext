...
export const DEV_ELECTRON_PROTOCOL_SCHEME = "hawknext";
export const DEV_ELECTRON_APP_NAME = "HawkNext Dev";
export const DEV_ELECTRON_APP_BUNDLE_ID = "dev.hawknext.app.development";
...
/**
 * 为 macOS 本地 Dev runtime 写入产品身份和 hawknext URL scheme。
 * raw Electron 的 Info.plist 没有 CFBundleURLTypes，系统只能把 hawknext 交给
...
export async function prepareDevElectronAppBundle({
  ...
  const sourceStampPath = join(dirname(appPath), ".hawknext-dev-electron-source.json");
