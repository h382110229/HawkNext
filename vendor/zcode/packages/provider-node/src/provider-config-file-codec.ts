import { z } from "zod";
import { modelSelectionSchema } from "@hawknext/shared/model-selection";
import { completeModelConfigDataSchema, modelConfigDataSchema } from "@hawknext/shared/model-config";
import {
