declare module "*.css";
declare module "@hawknext/ui/styles.css";
...
interface ImportMetaEnv {
  ...
  readonly VITE_HAWKNEXT_BASE_URL?: string;
  readonly VITE_HAWKNEXT_ENDPOINT_ORIGIN?: string;
  readonly VITE_HAWKNEXT_WEB_REMOTE_CONTROL_RELAY_WS_URL?: string;
}
