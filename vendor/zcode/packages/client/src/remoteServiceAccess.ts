import { ProxyChannel, type IChannelClient } from "@hawknext/rpc";
import {
  IFileService,
...
export class RemoteServiceAccess implements IServiceAccessor {
  ...
  readonly hawknextTaskService: IHawkNextTaskService;
  readonly windowControllerService: IWindowControllerService;
  readonly hawknextAgentService: IHawkNextAgentService;
  readonly hawknextSessionService: IHawkNextSessionService;
  ...
  constructor(channelClient: IChannelClient) {
    ...
    this.hawknextTaskService = ProxyChannel.toService<IHawkNextTaskService>(
      channelClient.getChannel(IHawkNextTaskService.channelName),
    );
    ...
    this.hawknextAgentService = ProxyChannel.toService<IHawkNextAgentService>(
      channelClient.getChannel(IHawkNextAgentService.channelName),
    );
    this.hawknextSessionService = ProxyChannel.toService<IHawkNextSessionService>(
      channelClient.getChannel(IHawkNextSessionService.channelName),
    );
