import type { CommandAck } from "@hawknext/shared/hawknext-protocol-v4";
...
export async function sendWithConversationDelayE2E(
  ...
  const host =
    typeof window === "undefined"
      ? undefined
      : (window as Window & { __hawknextTransportDelayE2E?: DelayPlan });
  const plan = shouldExposeE2EStoreBridge() ? host?.__hawknextTransportDelayE2E : undefined;
