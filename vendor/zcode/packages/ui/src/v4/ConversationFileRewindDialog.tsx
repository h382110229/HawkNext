...
import type { V4ConversationFileRewindPreviewResult } from "@hawknext/shared/hawknext-protocol-v4";
...
function formatReason(reason: string, intl: ReturnType<typeof useHawkNextIntl>["intl"]) {
