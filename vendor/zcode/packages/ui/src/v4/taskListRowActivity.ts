...
const TASK_LIST_ROW_ACTIVITY_FIELD = "__hawknextSessionActivity" as const;
...
export type TaskListMetaWithActivity = HawkNextTaskMeta & {
  [TASK_LIST_ROW_ACTIVITY_FIELD]: TaskListRowActivity;
};

export function attachTaskListRowActivity<T extends HawkNextTaskMeta>(
  task: T,
...
export function getTaskListRowActivity(task: HawkNextTaskMeta): TaskListRowActivity | null {
...
function isTaskListRowRunning(task: HawkNextTaskMeta): boolean {
 ...
 */
export function isTaskListRowActive(task: HawkNextTaskMeta): boolean {
...
export function mergeTaskListMembershipFields(
  activityTask: HawkNextTaskMeta,
  membershipTask: HawkNextTaskMeta,
): HawkNextTaskMeta {
