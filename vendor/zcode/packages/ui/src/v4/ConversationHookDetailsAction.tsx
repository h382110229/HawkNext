...
import { TID_V4_HOOK_DETAILS_CONTENT, TID_V4_HOOK_DETAILS_TRIGGER, testId } from "@hawknext/shared";
import type { HookExecutionProjection, HookInvocationRow } from "@hawknext/shared/hawknext-protocol-v4";
