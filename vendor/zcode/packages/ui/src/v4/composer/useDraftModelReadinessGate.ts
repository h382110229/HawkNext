...
import { isHawkNextAgentProvider, HAWKNEXT_AGENT_PROVIDER, type HawkNextProvider } from "@hawknext/shared";
import type { IModelSelectionService, ModelSelectionView } from "@hawknext/services";
import {
...
export function useDraftModelReadinessGate(params: {
  ...
  const enabled = sessionId === null && isHawkNextAgentProvider(displayProvider);
