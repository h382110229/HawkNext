...
import type { ShortcutCommandId, HawkNextConfigOption } from "@hawknext/shared";
import {
...
function getChatToolbarShortcutKey(
  category: HawkNextConfigOption["category"],
...
interface ToolbarShortcutState {
  ...
  modelOption?: HawkNextConfigOption;
  modeOption?: HawkNextConfigOption;
  thoughtOption?: HawkNextConfigOption;
}
