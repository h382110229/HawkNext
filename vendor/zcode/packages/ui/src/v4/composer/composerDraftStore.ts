...
//
// 旧草稿面（hawknextSessionStore composerDraftByScopeId + chatComposerDraftStorage 写路径）
...
import { modelSelectionSchema, type ModelSelection } from "@hawknext/shared";
import { submissionModeSchema, type SubmissionMode } from "@hawknext/shared/hawknext-protocol-v4";
...
const STORAGE_KEY_PREFIX = "hawknext-v4-composer-drafts:v1:";
