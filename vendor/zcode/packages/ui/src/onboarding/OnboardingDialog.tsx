...
export function OnboardingDialog(props: {
  ...
  const onboardingDialogRequested = useHawkNextStore((state) => state.onboardingDialogRequested);
  const clearOnboardingDialogRequest = useHawkNextStore((state) => state.clearOnboardingDialogRequest);
      ...
      const confirmed = await confirmDialog({
        ...
        description: intl.formatMessage(
          { id: "onboarding.agentsFile.confirmDescription" },
          {
            ...
            target: agentsFileMigration.status?.targetPath ?? "~/.hawknext/AGENTS.md",
          },
        ),
