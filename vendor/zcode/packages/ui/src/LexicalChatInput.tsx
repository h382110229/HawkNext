...
function E2ELexicalInputBridgePlugin({ inputTestId }: { inputTestId?: string }) {
  ...
  useEffect(() => {
    ...
    const detachBridge = (input: HTMLElement | null) => {
      if (
        input &&
        (input as { __hawknextLexicalInputE2E?: typeof bridge }).__hawknextLexicalInputE2E === bridge
      ) {
        delete (input as { __hawknextLexicalInputE2E?: typeof bridge }).__hawknextLexicalInputE2E;
      }
    ...
    const attachBridge = (input: HTMLElement | null) => {
      ...
      Object.defineProperty(input, "__hawknextLexicalInputE2E", {
        configurable: true,
        value: bridge,
      });
