...
import type { HawkNextModelTrajectoryContentPart, HawkNextModelTrajectoryRecord } from "@hawknext/services";
...
export function ContentPartView({
  ...
  part: HawkNextModelTrajectoryContentPart;
  intl: IntlShape;
  sectionLabel?: string;
...
export function summarizeRecords(records: HawkNextModelTrajectoryRecord[]): {
  totalTokens: number;
  models: string[];
} {
  let totalTokens = 0;
