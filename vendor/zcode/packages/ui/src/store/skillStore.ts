...
interface SkillStoreState {
  ...
  initialize: (
    ...
    providerOrSkillsService: HawkNextProvider | ISkillsService,
  ...
  setEnabled: (
    skillId: string,
    providerOrEnabled: HawkNextProvider | boolean,
...
export const useSkillStore = create<SkillStoreState>((set, get) => ({
  ...
  async initialize(
    ...
    const provider = normalizeAgentProviderToHawkNextAgent(
      hasProvider ? providerOrSkillsService : HAWKNEXT_AGENT_PROVIDER,
    );
