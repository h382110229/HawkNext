...
const MCP_CONFIG_KEY = "hawknext-mcp-config";
export const MCP_DELETED_PRELOAD_KEY = "hawknext-mcp-deleted-preload";

export const DEFAULT_MCP_CONFIG: McpConfig = {
  mcp: { mcpServers: {} },
  hawknextagentmcp: { mcpServers: {}, projects: {} },
};
...
export function makeServerId(
  ...
  const sourceKey =
    source === "hawknextagentmcp" && directorySource && directorySource !== "hawknext"
...
export function buildServerList(
  ...
  existingServers: HawkNextMcpServer[],
): HawkNextMcpServer[] {
  ...
  function makeServer(
    ...
    source: McpSource,
    scope: HawkNextMcpServer["scope"],
    enabledBySource?: boolean,
    projectPath?: string,
    file?: HawkNextMcpServer["file"],
    location?: HawkNextMcpServer["location"],
  ): HawkNextMcpServer {
  ...
  const servers: HawkNextMcpServer[] = [];
...
export function getServerPriority(server: HawkNextMcpServer): number {
