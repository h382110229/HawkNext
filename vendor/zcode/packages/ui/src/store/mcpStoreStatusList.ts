import type { McpServerStatus, HawkNextMcpServer, HawkNextMcpServerStatusSnapshot } from "@hawknext/shared";
...
function mapRuntimeStatusToUi(snapshot: HawkNextMcpServerStatusSnapshot): MappedMcpServerStatus {
