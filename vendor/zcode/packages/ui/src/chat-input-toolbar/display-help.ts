...
export const HAWKNEXT_MODE_OPTION_LABEL_IDS: Record<HawkNextProvider, Record<string, string>> = {
  glm: {
...
export const HAWKNEXT_MODE_OPTION_DESCRIPTION_IDS: Record<HawkNextProvider, Record<string, string>> = {
  glm: {
