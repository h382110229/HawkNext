...
import { TID_APP_HEADER } from "@hawknext/shared";
...
import type { ComposerMentionPrefill } from "@/store/hawknextSessionStoreTypes.js";
...
const WORKSPACE_SIDEBAR_WIDTH_STORAGE_KEY = "hawknext:workspace-shell:sidebar-width-px";
...
export const WorkspaceShellLayout = memo(function WorkspaceShellLayoutComponent({
  ...
  usePaneSessionPersistence({
    ...
    draftFocusVersion: workspaceShellHawkNextState.draftFocusVersion,
  ...
  return (
    <DesktopWindowFrame
      title={`HawkNext / ${getPathLeaf(workspaceAbsPath)}`}
      showHeader
      isDesktop={isDesktop}
                    ...
                    {shouldRenderWorkspaceHeader ? (
                      ...
                      >
                        <WorkspaceHeader
                          ...
                          workspaceHeaderState={workspaceShellHawkNextState}
                          gitSummary={gitState.summary}
