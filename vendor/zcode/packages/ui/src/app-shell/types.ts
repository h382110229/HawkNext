...
import type { IFeedbackService, IServiceAccessor } from "@hawknext/services";
...
import type { WorkspaceHawkNextUIState } from "@/store/hawknextSessionStore.js";
...
export interface WorkspaceShellHawkNextState {
  activeTaskId: WorkspaceHawkNextUIState["activeTaskId"];
  draftFocusVersion: WorkspaceHawkNextUIState["draftFocusVersion"];
  modelSwitchPending: WorkspaceHawkNextUIState["modelSwitchPending"];
  modelSwitchStage: WorkspaceHawkNextUIState["modelSwitchStage"];
  selectedProvider: WorkspaceHawkNextUIState["selectedProvider"];
  optimisticTaskListByTaskId: WorkspaceHawkNextUIState["optimisticTaskListByTaskId"];
  workspaceInit: WorkspaceHawkNextUIState["workspaceInit"];
...
export type CreateTaskRequest = HawkNextProvider | CreateTaskOptions;
...
export interface WorkspaceShellLayoutProps extends Omit<AppProps, "baseFeedbackService"> {
  ...
  workspaceTabs: Array<{
    ...
    remoteTarget?: import("@hawknext/shared").RemoteTarget;
    workspaceIdentity?: string;
  ...
  handleStartDraftInWorkspace: (
    targetWorkspacePath: string,
    targetWorkspaceIdentity?: string,
    targetWorkspacePurpose?: import("@hawknext/shared").WorkspacePurpose,
    createSource?: SessionCreateSource,
  ) => void;
