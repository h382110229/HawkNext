...
const HIGHLIGHT_NAME = "hawknext-model-trajectory-find";
const ACTIVE_HIGHLIGHT_NAME = "hawknext-model-trajectory-find-active";
const STYLE_ID = "hawknext-model-trajectory-find-highlight-style";
