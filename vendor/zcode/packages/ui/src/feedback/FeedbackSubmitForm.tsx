...
import type { IFeedbackService } from "@hawknext/services";
...
function useActiveFeedbackModelContext(): FeedbackAgentModelContext {
  ...
  return useMemo(
    () => readCurrentAgentModelContext(workspaceHawkNextState?.configOptions),
    [workspaceHawkNextState?.configOptions],
  );
}
