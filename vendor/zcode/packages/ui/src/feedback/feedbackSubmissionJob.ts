...
import type { CreateFeedbackTicketInput, FeedbackAttachmentKind } from "@hawknext/shared";
import type { FeedbackUploadProgress, IFeedbackService } from "@hawknext/services";
