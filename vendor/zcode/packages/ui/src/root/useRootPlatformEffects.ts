...
export function useRootPlatformEffects({
  ...
  initialWorkspacePurpose?: import("@hawknext/shared").WorkspacePurpose;
  ...
  isDesktop?: boolean;
  locale: ReturnType<typeof import("@/i18n/IntlProvider.js").useHawkNextIntl>["locale"];
  tabs: WindowTabState[];
  ...
  intl: ReturnType<typeof import("@/i18n/IntlProvider.js").useHawkNextIntl>["intl"];
  ...
  useEffect(() => {
    ...
    const disposeNotificationClick = platform.onTaskNotificationClick((taskId: string) => {
      ...
      const workspaces = useHawkNextSessionStore.getState().workspaces;
  ...
  useEffect(() => {
    ...
    void baseServices.conversationShareService
      ...
      .then((result) => {
        ...
        const sessionStore = useHawkNextSessionStore.getState();
  ...
  useEffect(() => {
    ...
    syncActiveSession();
    return useHawkNextSessionStore.subscribe(syncActiveSession);
