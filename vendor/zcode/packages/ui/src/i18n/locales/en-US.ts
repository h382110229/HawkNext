...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like HawkNext to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let HawkNext remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting HawkNext",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen HawkNext.",
  ...
  "startup.global.starting_services": "Starting HawkNext",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "HawkNext will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another HawkNext or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen HawkNext. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen HawkNext to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen HawkNext.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a HawkNext restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into HawkNext",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to HawkNext and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to HawkNext",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to HawkNext",
  "login.description": "Connect your account to start using HawkNext",
  ...
  "login.oauth.button.cloud-cn": "Connect to CloudCN",
  "login.oauth.regionTag.zai": "Global",
  "login.oauth.regionTag.cloud-cn": "CN",
  ...
  "login.apiKey.provider.cloud-cn": "CloudCN",
  ...
  "logout.confirm.title": "Disconnect and restart HawkNext?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only HawkNext Agent writes model-io)",
  ...
  "titleBar.menu.help.about": "About HawkNext",
  ...
  "titleBar.menu.help.toggleHawkNextStdioTap": "Capture agent stdio traffic",
  ...
  "forceUpdate.title": "Update HawkNext to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart HawkNext to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the HawkNext CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "HawkNext checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.legacyLayout": "Use legacy layout",
  "settings.legacyLayout.description": "Fall back to stock shell chrome (turn off HawkBrain skin anytime)",
  "delivery.wizard.entry": "Delivery Wizard",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the HawkNext terminal font.",
  ...
  "settings.hawknextInteractionBehavior": "Interaction behavior",
  "settings.hawknextInteractionBehaviorDescription":
    "While HawkNext is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  "settings.hawknextInteractionBehavior.option.queue": "Queue",
  "settings.hawknextInteractionBehavior.option.guide": "Guide",
  ...
  "settings.dataBaseDirDescription":
    "Root directory for app data (defaults to user home directory). Existing data will be copied to the new location. The .hawknext/v2 suffix cannot be changed.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the HawkNext installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching HawkNext task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by HawkNext",
  ...
  "resourceManager.storage.diskUsage": "HawkNext uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the HawkNext desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "HawkNext could not verify its Windows secure import component. Reinstall or update HawkNext before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, HawkNext will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by HawkNext Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "HawkNext provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This HawkNext Agent cannot refresh OAuth status. Upgrade or restart HawkNext, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to HawkNext to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into HawkNext",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to HawkNext 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by HawkNext automatically.",
  ...
  "settings.modelProvider.codingPlan.cloud-cn.unregisteredHint":
    "This CloudCN account is not registered yet. Register first.",
  "settings.modelProvider.codingPlan.cloud-cn.registerAction": "Register",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the CloudCN team plan management page. Once assigned, the team quota will be available in HawkNext.",
  ...
  "settings.modelProvider.codingPlan.openApiKeyProvider": "Open CloudCN - API key",
  ...
  "settings.modelProvider.codingPlan.dynamicUnsupportedDescription":
    "In-app subscription is only connected for  / CloudCN Coding Plan right now.",
  ...
  "settings.modelProvider.codingPlan.zaiOverseasPaymentRequired":
    " overseas plans must be paid through PayPal or the official  payment page, not the Alipay signing flow.",
  ...
  "settings.modelProvider.codingPlan.start.loginTrial": "Connect ",
  ...
  "settings.modelProvider.codingPlan.enterprise.productsLoadingDescription":
    "Loading team plan pricing from CloudCN.",
  ...
  "settings.modelProvider.codingPlan.enterprise.paymentNotesDescription":
    "Balance and gift deductions are estimated by CloudCN. Continuous subscriptions must keep at least the required third-party payment amount.",
  ...
  "settings.modelProvider.codingPlan.overseasPayment.description":
    "Amount due: {price}. Choose PayPal or continue on the official  payment page.",
  ...
  "settings.modelProvider.codingPlan.overseasPayment.authorizationPrefix":
    "You agree that  will charge your card the above amount now and on a recurring basis according to your subscription plan until you cancel in accordance with our ",
  ...
  "settings.modelProvider.codingPlan.cloud-cn.plan.lite.name": "Lite",
  "settings.modelProvider.codingPlan.cloud-cn.plan.lite.summary": "3x Claude Pro usage quota",
  "settings.modelProvider.codingPlan.cloud-cn.plan.pro.name": "Pro",
  "settings.modelProvider.codingPlan.cloud-cn.plan.pro.summary":
    "5x Lite usage quota + all Lite benefits",
  "settings.modelProvider.codingPlan.cloud-cn.plan.max.name": "Max",
  "settings.modelProvider.codingPlan.cloud-cn.plan.max.summary":
    "20x Lite usage quota + all Pro benefits",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.lite.detail0": "Base usage allowance",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.lite.detail1":
    "Light iteration for small repos",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.lite.detail2":
    "Latest models rolled out over time",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.lite.detail3": "20+ coding tools",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.pro.detail0": "5x Lite usage allowance",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.pro.detail1":
    "Daily development for mid-sized repos",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.pro.detail2":
    "Priority access to latest models",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.pro.detail3": "Curated MCP tools",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.max.detail0":
    "20x Lite usage allowance",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.max.detail1":
    "Deep work on mid-to-large repos",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.max.detail2":
    "First access to latest models",
  "settings.modelProvider.codingPlan.cloud-cn.purchase.plan.max.detail3":
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. HawkNext uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.modelProvider.modelApiFormat.official-modelCompatible": "OfficialModel Compatible",
  "settings.modelProvider.modelApiFormat.official-modelResponses": "OfficialModel Responses",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in HawkNext after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "HawkNext MCP",
  ...
  "settings.usage.entitlementNotConfigured":
    "No connected  or CloudCN Coding Plan account is available for quota lookup. Connect a Coding Plan account first.",
  ...
  "sidebar.usage.plan.mcp": "HawkNext MCP",
  "sidebar.usage.plan.hawknextMcp": "HawkNext MCP",
  "sidebar.usage.plan.hawknextMcpDescription": "Daily aggregate quota for HawkNext built-in plugin MCPs",
  ...
  "settings.usage.codingPlanNotConfiguredDescription":
    "Connect a  or CloudCN Coding Plan provider in Model Settings to view plan quota, model usage, and tool usage.",
  ...
  "settings.modelProvider.presetDescription":
    "Built-in  and CloudCN providers with OAuth-assisted configuration.",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into HawkNext. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. HawkNext follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into HawkNext",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by HawkNext Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend HawkNext with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into HawkNext and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. HawkNext follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into HawkNext",
  ...
  "settings.commands.description":
    "Manage HawkNext Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.hawknextAgent": "HawkNext Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into HawkNext. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. HawkNext follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into HawkNext",
  ...
  "settings.workspaceFileSearch.description":
    "Edit .hawknextignore rules (gitignore syntax) that scope workspace file search. Takes effect on the next search after saving.",
  "settings.workspaceFileSearch.templateHint":
    ".hawknextignore does not exist yet: the content below is the initial preview (.gitignore copy + default exclusions); it is written to the workspace only after saving.",
  ...
  "settings.workspaceFileSearch.revealHint": "Save first; .hawknextignore lives at the workspace root",
  ...
  "settingsSync.action.finish": "Start using HawkNext",
  "settingsSync.agent.hawknext": "HawkNext Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current HawkNext settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to HawkNext",
  ...
  "onboarding.welcome.title": "Welcome to HawkNext",
  "onboarding.welcome.start": "Start HawkNext",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while HawkNext imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "HawkNext will copy {source} to {target}.\nIf the target file already exists, the HawkNext default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask HawkNext anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask HawkNext anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, HawkNext will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want HawkNext to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart HawkNext app and retry, or ask HawkNext to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with HawkNext in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for HawkNext: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with HawkNext in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current HawkNext Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'HawkNext MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No HawkNext MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  // HawkNext Agent
  "hawknext.unavailable": "AI agent not available",
  "hawknext.initFailed": "Failed to start AI agent",
  "hawknext.error.TASK_OWNED_BY_OTHER_HOST": "This task is already running in another connected view.",
  "hawknext.error.STALE_TASK_OWNER_COMMAND": "This action belongs to an older run and was ignored.",
  "hawknext.error.NO_ACTIVE_TASK_OWNER": "No active task owner is available for this action.",
  "hawknext.error.OWNER_COMMAND_FAILED": "The task owner could not complete this action.",
  "hawknext.error.MEDIA_BUDGET_CURRENT_ATTACHMENT_TOO_LARGE":
    "Current attachments are too large for one request. Remove or compress attachments and try again.",
  "hawknext.error.MEDIA_BUDGET_CURRENT_IMAGE_TOO_LARGE":
    "Current image attachments are too large. Remove or compress images and try again.",
  "hawknext.error.MEDIA_BUDGET_CURRENT_VIDEO_TOO_LARGE":
    "Current video attachments are too large. Remove or compress videos and try again.",
  "hawknext.error.HAWKNEXT_RUNTIME_MODEL_UNAVAILABLE":
    "The current model is no longer available. Select an available model from the current model list to continue.",
  "hawknext.error.HAWKNEXT_CLOUD_CN_TEAM_PLAN_MEMBER_REQUIRED":
    "The current model is unavailable. Check whether the current account has been added to the project member list.",
  "hawknext.error.providerBusiness.1006": "Your login session has expired. Please sign in again.",
  "hawknext.error.providerBusiness.1005":
    "Today's free plan quota has been used up. Upgrade to continue now, or wait for the quota to reset.",
  "hawknext.error.providerBusiness.3006":
    "The current model is not included in this plan. Switch to an allowed model and try again.",
  "hawknext.error.providerBusiness.3002":
    "You're sending requests too quickly. Please try again later.",
  "hawknext.error.providerBusiness.3001":
    "The request parameters are invalid. Check the input and try again.",
  "hawknext.error.providerBusiness.3007":
    "The request was rejected by the gateway security check. Please try again later or contact support.",
  "hawknext.error.providerBusiness.3008":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "hawknext.error.providerBusiness.3009":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "hawknext.error.providerBusiness.3010":
    "The system is busy. Please switch models, upgrade your account, or try again later.",
  "hawknext.error.providerBusiness.3102":
    "This run exceeded the maximum single-run time. Create a new off-peak task to continue.",
  "hawknext.error.modelSuspiciousEmpty":
    "The model returned no content (often caused by an expired token or plan issues). Please send again.",
  "hawknext.error.providerBusiness.2007":
    "The upstream service is temporarily unavailable. Please try again later.",
  "hawknext.error.providerBusiness.429":
    "You're sending requests too quickly. Please try again later.",
  ...
  "resourceManager.appUsage": "HawkNext",
  ...
  "feedback.submit.template.section.copyErrorHeading": "HawkNext Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while HawkNext is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task HawkNext can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "HawkNext Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "HawkNext Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart HawkNext",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart HawkNext to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified HawkNext plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "HawkNext will verify the Computer Use tools against the exact session when your first session starts.",
