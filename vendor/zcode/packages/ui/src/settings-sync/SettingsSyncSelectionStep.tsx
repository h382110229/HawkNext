...
import type { SettingsSyncCategory, SettingsSyncDiscoveryResult } from "@hawknext/shared";
...
function formatAgentName(agent: string, intl: ReturnType<typeof useHawkNextIntl>["intl"]): string {
  switch (agent) {
    case "hawknext":
      return intl.formatMessage({ id: "settingsSync.agent.hawknext" });
    case "claudeCode":
