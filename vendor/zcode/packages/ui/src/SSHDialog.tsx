...
import { createUuid, type RemoteTarget, type RemoteWorkspaceSessionEntry } from "@hawknext/shared";
import {
                ...
                {currentStep === "directory" ? (
                  <div data-testid={TID_SSH_SUCCESS} className="h-full">
                    <RemoteConnectionDirectoryStep
                      ...
                      remoteHawkNextAgentService={directoryBrowserServices?.hawknextAgentService ?? null}
