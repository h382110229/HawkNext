...
import { TID_CRON_CREATE_CARD, TID_CRON_CREATE_OPEN } from "@hawknext/shared";
import type { HawkNextAutomationScheduleRule } from "@hawknext/shared";
...
function isScheduleRule(value: unknown): value is HawkNextAutomationScheduleRule {
...
function readCronCreateAutomationOutputSummary(value: unknown): CronCreateAutomationSummary | null {
  ...
  const scheduleRule = isScheduleRule(automation.scheduleRule)
    ? (automation.scheduleRule as HawkNextAutomationScheduleRule)
    : undefined;
