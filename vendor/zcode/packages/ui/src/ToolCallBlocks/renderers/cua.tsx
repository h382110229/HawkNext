...
import type { ApplicationIconRequest } from "@hawknext/shared";
import { useHawkNextIntl } from "@/i18n/IntlProvider.js";
import { isHawkNextCuaToolName } from "@/lib/cuaPermissionAction.js";
...
function readCuaToolName(value: string | null | undefined): string | null {
  ...
  //   main namesp: mcp__plugin_hawknext_cua_computer_use__<action>
...
export function isCuaToolCall(
  ...
  return collectToolNames(toolCall).some(isHawkNextCuaToolName);
}
...
type CuaIntl = ReturnType<typeof useHawkNextIntl>["intl"];
