 ...
 *
 * 一行的读法与模型面
 * （apps/hawknext-cli/packages/core/src/tool/handlers/get-workflow-run-format-roster.ts）同一句话：
...
import type { ToolCallGetWorkflowRunDisplay } from "@hawknext/shared/hawknext-protocol-v4";
...
type FormatMessage = ReturnType<typeof useHawkNextIntl>["intl"]["formatMessage"];
