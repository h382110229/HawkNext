...
const HOST_ATTRIBUTE = "data-hawknext-pptx-print-host";
const PAGE_ATTRIBUTE = "data-hawknext-pptx-print-page";
const STYLE_ATTRIBUTE = "data-hawknext-pptx-print-style";
