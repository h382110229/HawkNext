...
import { unpackWorkspaceFileEntries } from "@hawknext/shared/workspaceFileEntriesCodec";
...
import type { WorkspaceFileEntry, HawkNextTaskChangeSummary, HawkNextTaskMeta } from "@hawknext/shared";
import {
  Command,
  CommandDialog,
  CommandEmpty,
...
type TaskSearchResultItem = HawkNextTaskMeta & {
  searchSnippet?: string;
  searchSnippets?: string[];
};
type TaskChangedFileSummary = HawkNextTaskChangeSummary["files"][number];
...
function getTaskTitle(task: HawkNextTaskMeta, untitledLabel: string): string {
