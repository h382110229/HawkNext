import type { HawkNextTaskGroupColor } from "@hawknext/services";
...
const TASK_GROUP_COLOR_CLASS: Record<HawkNextTaskGroupColor, string> = {
...
const TASK_GROUP_BORDER_COLOR_CLASS: Record<HawkNextTaskGroupColor, string> = {
