...
import type { HawkNextGroupedTaskViewNode, HawkNextTaskGroupColor } from "@hawknext/services";
import {
...
export function GroupItem({
  ...
  getTaskRemoteSessionId: (task: HawkNextTaskMeta) => string | undefined;
  getTaskWorkspaceLabel: (task: HawkNextTaskMeta) => string;
  onSelectTask: (workspacePath: string, taskId: string, workspaceIdentity?: string) => void;
  onCloseTask: (task: HawkNextTaskMeta) => void;
  onOpenFileTree?: (task: HawkNextTaskMeta) => void;
  onCreateTask: () => void;
  ...
  onUpdateGroupColor: (groupId: string, color: HawkNextTaskGroupColor) => void;
  onUngroupGroup: (groupId: string) => void;
  onMoveTaskToGroup: (task: HawkNextTaskMeta, groupId: string | null) => void;
  onMoveTaskToTop: (task: HawkNextTaskMeta) => void;
  onStartRenameTask: (task: HawkNextTaskMeta) => void;
  onArchiveTask: (task: HawkNextTaskMeta) => void;
  onMarkTaskAsUnread: (task: HawkNextTaskMeta) => void;
  ...
  const handleGroupColorChange = useCallback(
    (color: string) => {
      onUpdateGroupColor(node.group.id, color as HawkNextTaskGroupColor);
    },
