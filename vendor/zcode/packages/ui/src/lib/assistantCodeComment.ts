  ...
  if (options.streaming) {
    ...
    if (unclosedStart !== null) {
      ...
      const prefixStart = findAssistantDirectivePrefixStart(
        content,
        [CODE_COMMENT_DIRECTIVE_NAME, "hawknext-file-citation"],
        protectedRanges,
        {
          minimumSingleColonPrefixLength: ":hawknext".length,
          singleColonDirectiveNames: ["hawknext-file-citation"],
          tripleColonDirectiveNames: ["hawknext-file-citation"],
        },
      );
      if (prefixStart !== null) {
