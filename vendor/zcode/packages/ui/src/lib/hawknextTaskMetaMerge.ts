...
function hasOwnTaskMetaField<T extends keyof HawkNextTaskMeta>(task: HawkNextTaskMeta, key: T) {
...
function resolveMergedTaskTitle(preferredTask: HawkNextTaskMeta, fallbackTask: HawkNextTaskMeta): string {
...
export function mergeTaskWithOptimisticMeta(
  ...
  optimisticTask: HawkNextTaskMeta,
): HawkNextTaskMeta {
...
export function mergeTaskMetaCandidates(
  ...candidates: Array<HawkNextTaskMeta | null | undefined>
): HawkNextTaskMeta | undefined {
  let merged: HawkNextTaskMeta | undefined;
