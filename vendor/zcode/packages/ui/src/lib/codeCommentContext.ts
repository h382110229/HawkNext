export const CODE_COMMENT_ADD_TO_CHAT_EVENT = "hawknext:code-comment-add-to-chat";
export const CODE_COMMENT_REMOVE_FROM_CHAT_EVENT = "hawknext:code-comment-remove-from-chat";
