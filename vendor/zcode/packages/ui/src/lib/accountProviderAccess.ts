...
import { type HawkNextProviderAccountAccess, hawknextProviderAccountAccessSchema } from "@hawknext/shared";

interface EntitledAccountProviderAccess {
  readonly providerId: string;
  readonly access: HawkNextProviderAccountAccess;
...
export function resolveEntitledAccountProviderAccess(
  ...
  const parsed = hawknextProviderAccountAccessSchema.safeParse(provider.effectiveConfig.access);
