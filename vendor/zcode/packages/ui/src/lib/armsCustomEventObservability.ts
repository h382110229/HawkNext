import type { ArmsCustomEventPayload } from "@hawknext/shared";
...
type ArmsCustomEventDebugWindow = Window & {
  __hawknextArmsCustomEventsE2E?: ArmsCustomEventE2EEntry[];
};
...
export function recordArmsCustomEventForE2E(
  ...
  const buffer = (host.__hawknextArmsCustomEventsE2E ??= []);
  buffer.push({
    ...payload,
