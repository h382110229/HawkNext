const TASK_NOTIFICATION_ENABLED_STORAGE_KEY = "hawknext-notification-enabled";
const TASK_NOTIFICATION_SOUND_ENABLED_STORAGE_KEY = "hawknext-notification-sound-enabled";
