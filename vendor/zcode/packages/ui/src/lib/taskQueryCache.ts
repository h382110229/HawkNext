...
import { resolveWorkspaceStateKey } from "@/store/hawknextSessionStoreSelectors.js";

export type TaskEntityKey = string;
export type TaskListCacheKey = string;
export type TaskListQueryKind = HawkNextTaskListKind | "workspace";
...
function normalizeTaskListWorkspaceScopes(
  ...
  const uniqueScopes = new Map<string, HawkNextTaskListWorkspaceScope>();
