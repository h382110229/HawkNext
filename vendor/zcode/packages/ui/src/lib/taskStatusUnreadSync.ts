...
import type { HawkNextTaskMeta, HawkNextWorkspaceTaskListChanged } from "@hawknext/shared";
...
import { getTaskUnreadIndicator, useHawkNextSessionStore } from "@/store/hawknextSessionStore.js";
import { bumpTaskListMembershipVersion } from "@/v4/taskListMembershipVersion.js";
import { logger } from "@/logger.js";

type TaskUnreadService = Pick<IHawkNextTaskService, "setTaskUnread">;
...
function buildStatusUnreadKey(event: HawkNextWorkspaceTaskListChanged, taskId: string): string {
...
function shouldMarkStatusEventTaskUnread(params: {
  ...
  event: HawkNextWorkspaceTaskListChanged;
}): boolean {
