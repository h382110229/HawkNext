...
interface ResolveWorkspaceSwitchDraftProviderOptions {
  currentSelectedProvider: HawkNextProvider;
  targetWorkspacePath: string;
  targetWorkspaceIdentity?: string;
  workspaces: Record<string, WorkspaceHawkNextUIState | undefined>;
}
...
export function resolveWorkspaceSwitchDraftProvider({
  ...
  workspaces,
}: ResolveWorkspaceSwitchDraftProviderOptions): HawkNextProvider {
