...
const OFFICIAL_PLUGIN_ICON_BY_ID: Readonly<Record<string, string>> = {
  "documents@hawknext-plugins-official": documentsIconUrl,
  "image-search@hawknext-plugins-official": imageSearchIconUrl,
  "pdf@hawknext-plugins-official": pdfIconUrl,
  "plugin-creator@hawknext-plugins-official": pluginCreatorIconUrl,
  "presentations@hawknext-plugins-official": presentationsIconUrl,
  "spreadsheets@hawknext-plugins-official": spreadsheetsIconUrl,
};
