...
export const WORKSPACE_FILE_DRAG_MIME = "application/x-hawknext-workspace-file";
export const WORKSPACE_FILE_ADD_TO_CHAT_EVENT = "hawknext:add-workspace-file-to-chat";
export const WORKSPACE_FILE_DRAG_STATE_EVENT = "hawknext:workspace-file-drag-state";
