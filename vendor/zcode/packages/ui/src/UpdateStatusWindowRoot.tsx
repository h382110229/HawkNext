import type { IPlatformService, Locale, UpdateStatePayload } from "@hawknext/shared";
import { useCallback, useEffect, useRef, useState } from "react";
import { HawkNextIntlProvider } from "@/i18n/IntlProvider.js";
...
export function UpdateStatusWindowRoot({
  ...
  return (
    <div className="min-h-screen bg-transparent text-foreground">
      ...
      <HawkNextIntlProvider key={locale} initialLocale={locale}>
