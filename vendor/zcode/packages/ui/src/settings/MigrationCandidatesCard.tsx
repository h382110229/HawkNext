...
import type {
  ...
  HawkNextImportedSessionSkippedItem,
...
function ImportIssuesList({
  ...
  title: string;
  items: HawkNextImportedSessionSkippedItem[];
}) {
...
export function MigrationCandidatesCard({
  ...
  candidates: HawkNextImportableSessionCandidate[];
  selectedSessionIds: string[];
  selectedCount: number;
  importError: string | null;
  lastImportResult: HawkNextImportSessionsResult | null;
  isImporting: boolean;
