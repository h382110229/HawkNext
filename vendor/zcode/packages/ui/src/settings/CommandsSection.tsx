...
import type { CommandConfig, UserCommand, HawkNextCommand } from "@hawknext/shared";
...
export function CommandsSection({
  ...
  const handleToggle = useCallback(
    async (command: HawkNextCommand, enabled: boolean) => {
  ...
  const renderCommandList = (items: HawkNextCommand[]) => (
    <SettingsResourceList
      items={items}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <CommandForm
            ...
            agentSource={editingCommand?.agentSource ?? HAWKNEXT_COMMAND_AGENT_SOURCE}
            scopeKey={formScopeKey}
