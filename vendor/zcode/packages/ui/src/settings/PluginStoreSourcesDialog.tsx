...
import type { HawkNextPluginMarketplaceSummary } from "@hawknext/shared";
...
function isRemovableMarketplace(marketplace: HawkNextPluginMarketplaceSummary): boolean {
...
function PluginStoreSourceRefreshFailure({
  ...
  failure: NonNullable<HawkNextPluginMarketplaceSummary["refreshFailure"]>;
}) {
