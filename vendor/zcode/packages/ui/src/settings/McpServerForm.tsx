...
import type { McpSource, HawkNextMcpServer } from "@hawknext/shared";
...
export function McpServerForm({
  ...
  onSave: (form: FormState, prevServer?: HawkNextMcpServer) => void;
  onCancel: () => void;
  onDelete?: (server: HawkNextMcpServer) => void;
}) {
  const { intl } = useHawkNextIntl();
