import type { McpServerConfig, HawkNextMcpServer } from "@hawknext/shared";

export const MCP_SECTIONS = ["hawknextagentmcp"] as const;
...
export function serverToForm(server: HawkNextMcpServer): FormState {
...
// 与 shared 层 convertToHawkNextAgentMcpServer 的 isMcpProtocolVersion 守卫保持同一语义：
