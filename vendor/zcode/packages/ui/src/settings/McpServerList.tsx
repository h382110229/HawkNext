...
function McpServerItem({
  ...
  server: HawkNextMcpServer;
  onEdit: (server: HawkNextMcpServer) => void;
  onToggle: (id: string, enabled: boolean) => void;
  onOpenAuthorization?: (server: HawkNextMcpServer) => void;
  ...
  const canEdit = !server.location || server.location.source === "hawknext";
