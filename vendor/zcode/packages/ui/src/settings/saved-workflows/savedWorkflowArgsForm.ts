...
import type { HawkNextSavedWorkflowArgType, HawkNextSavedWorkflowArgsDeclaration } from "@hawknext/shared";

export interface SavedWorkflowArgField {
  name: string;
  type: HawkNextSavedWorkflowArgType;
  description?: string;
  required: boolean;
  hasDefault: boolean;
...
function formatSavedWorkflowArgValue(type: HawkNextSavedWorkflowArgType, value: unknown): string {
...
export function buildSavedWorkflowArgFields(
  declaration: HawkNextSavedWorkflowArgsDeclaration | undefined,
...
type SavedWorkflowArgRowsCollect =
  | { ok: true; args: HawkNextSavedWorkflowArgsDeclaration | undefined }
...
export function rowsToArgsDeclaration(
  ...
  const args: HawkNextSavedWorkflowArgsDeclaration = {};
