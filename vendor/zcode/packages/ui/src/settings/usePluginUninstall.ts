...
import type { HawkNextInstalledPluginSummary, HawkNextPluginInfo } from "@hawknext/shared";
...
interface PluginUninstallController {
  pendingPlugin: HawkNextPluginInfo | HawkNextInstalledPluginSummary | null;
