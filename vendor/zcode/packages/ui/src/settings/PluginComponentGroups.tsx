import type { HawkNextPluginComponentKind } from "@hawknext/shared";
...
export interface PluginComponentDisplayGroup {
  kind: HawkNextPluginComponentKind;
...
const COMPONENT_BADGE_STYLES: Record<HawkNextPluginComponentKind, string> = {
...
const COMPONENT_LABEL_IDS: Record<HawkNextPluginComponentKind, string> = {
