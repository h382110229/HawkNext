import type { ProviderConfigObject } from "@hawknext/provider";
...
import cloudCnLogo from "@/assets/provider-icons/logo-cloud-cn.svg";
...
import openAiLogo from "@/assets/provider-icons/model-provider-official-model.png";
...
const BUILTIN_PROVIDER_LOGO_ASSETS: Readonly<Record<string, BuiltinProviderLogoAsset>> = {
  ...
  officialModel: { light: openAiLogo },
