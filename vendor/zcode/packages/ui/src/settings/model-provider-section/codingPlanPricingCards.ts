...
export function resolveCodingPlanUpgradeProductsProviderId(
  ...
  // Start Plan 是免费入口，编程套餐列表应直接展示原  Coding Plan 付费套餐。
  ...
  // CloudCN Start Plan 同样是免费入口，展开升级时必须使用
  // CloudCN paid Coding Plan 商品源，不能拿 Start providerId 请求免费 SKU。
  return providerId === BUILTIN_MODEL_PROVIDER_IDS.cloudCnStartPlan
