import {
  ...
  buildCloudCNApiUrl,
  buildCloudCNCodingPlanPersonalManageUrl,
...
export const CLOUD_CN_REGISTRATION_URL = buildCloudCNApiUrl({ HAWKNEXT_ENV }, "/login");
const CLOUD_CN_CODING_PLAN_PERSONAL_MANAGE_URL = buildCloudCNCodingPlanPersonalManageUrl({
  HAWKNEXT_ENV,
});
...
export const CODING_PLAN_PROVIDER_SPECS: CodingPlanProviderSpec[] = [
  {
    ...
    label: " - Coding Plan",
    providerName: "",
    purchaseUrl: "https:///manage-apikey/subscription",
  },
  {
  ...
  },
  {
    ...
    oauthProviderId: CLOUD_CN_PROVIDER_ID,
    label: "CloudCN - Coding Plan",
    providerName: "CloudCN",
    purchaseUrl: CLOUD_CN_CODING_PLAN_PERSONAL_MANAGE_URL,
  },
  {
    id: BUILTIN_MODEL_PROVIDER_IDS.cloudCnStartPlan,
    oauthProviderId: CLOUD_CN_PROVIDER_ID,
...
export function resolveModelProviderDisplayName(
  ...
  if (provider.providerId === BUILTIN_MODEL_PROVIDER_IDS.cloudCnStartPlan) {
    return "Start Plan";
  }
