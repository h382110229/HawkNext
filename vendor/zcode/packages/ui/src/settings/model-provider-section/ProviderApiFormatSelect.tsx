import type { ProviderApiType } from "@hawknext/provider";
import {
  Select,
  SelectContent,
  SelectItem,
...
const PROVIDER_CONNECTION_API_FORMAT_PATHS: Record<ProviderApiType, string> = {
  ...
  "official-model-chat-completions": "/chat/completions",
  "official-model-responses": "/responses",
};
...
const PROVIDER_CONNECTION_API_FORMAT_TITLE_IDS: Record<ProviderApiType, string> = {
  ...
  "official-model-chat-completions": "settings.modelProvider.apiFormat.title.chatCompletions",
  "official-model-responses": "settings.modelProvider.apiFormat.title.responses",
};
