...
import type { HawkNextPluginDiagnostic, HawkNextPluginInfo } from "@hawknext/shared";
 ...
 */
export function PluginWarningList({ warnings }: { warnings: HawkNextPluginDiagnostic[] }) {
  return (
...
export function PluginHookDetails({
  ...
  hooks: NonNullable<HawkNextPluginInfo["hookDetails"]>;
}) {
...
function formatHookCommand(hook: NonNullable<HawkNextPluginInfo["hookDetails"]>[number]): string {
