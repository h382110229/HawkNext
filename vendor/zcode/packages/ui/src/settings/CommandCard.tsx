...
import type { UserCommand, HawkNextCommand } from "@hawknext/shared";
import { isPluginCommand, isUserCommand } from "@hawknext/shared";
...
export function isEditableUserCommand(command: HawkNextCommand): command is UserCommand {
  return isUserCommand(command) && command.location.source === "hawknext";
}

interface CommandCardProps {
  command: HawkNextCommand;
  onEdit?: (command: HawkNextCommand) => void;
  onToggle?: (command: HawkNextCommand, enabled: boolean) => void;
  isOperating?: boolean;
