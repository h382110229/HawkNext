import type { HawkNextModelTrajectoryMessage } from "@hawknext/services";
...
type IntlShape = ReturnType<typeof useHawkNextIntl>["intl"];
...
function compactTextPreview(message: HawkNextModelTrajectoryMessage): string {
...
function firstLinePreview(message: HawkNextModelTrajectoryMessage): string {
...
function messageClipboardText(message: HawkNextModelTrajectoryMessage): string {
