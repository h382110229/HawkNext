...
export interface TestActions extends TaskListE2EActions {
  ...
  /** E2E 通过真实 hawknextAgentService 拉取插件 overview */
  getPluginsOverview: IHawkNextAgentService["getPluginsOverview"];
  /** E2E 通过真实 hawknextAgentService 添加 marketplace */
  addPluginMarketplace: IHawkNextAgentService["addPluginMarketplace"];
  /** E2E 通过真实 hawknextAgentService 刷新 marketplace */
  updatePluginMarketplace: IHawkNextAgentService["updatePluginMarketplace"];
  /** E2E 通过真实 hawknextAgentService 安装 marketplace plugin */
  installPlugin: IHawkNextAgentService["installPlugin"];
  /** E2E 通过真实 hawknextAgentService 触发插件 discover */
  listPlugins: IHawkNextAgentService["listPlugins"];
  /** E2E 通过真实 hawknextAgentService 查询 Workspace/Session Plugin catalog */
  getPluginReferenceCatalog: IHawkNextAgentService["getPluginReferenceCatalog"];
}
