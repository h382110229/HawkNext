...
import type { HawkNextElicitationQuestion, HawkNextElicitationRequest } from "@hawknext/shared";
import type { InteractionAutoResolution } from "@hawknext/shared/hawknext-protocol-v4";
...
interface ElicitationDialogProps {
  request: HawkNextElicitationRequest;
...
interface NormalizedElicitationQuestion extends HawkNextElicitationQuestion {
  key: string;
}
...
function isPlanApprovalElicitationRequest(request: HawkNextElicitationRequest): boolean {
