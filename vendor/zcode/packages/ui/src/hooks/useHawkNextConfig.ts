/**
 * HawkNext Agent ConfigOptions 便捷 hooks
 *
...
import type { ConfigOptionsStatus } from "@/store/hawknextSessionStoreTypes.js";
...
export function useToolbarConfigOptions(
  ...
  const { configOptions, configOptionsStatus } = useHawkNextSessionStore(
    useShallow((state) => {
