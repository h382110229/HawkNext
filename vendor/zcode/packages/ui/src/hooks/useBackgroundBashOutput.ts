...
import type { BackgroundBashOutput, BackgroundBashOutputResult } from "@hawknext/shared";
import { useHawkNextAgentService } from "@/hooks/useHawkNextAgentService.js";
...
export function useBackgroundBashOutput(target: BackgroundBashOutputTarget, visible: boolean) {
  ...
  const service = useHawkNextAgentService(workspacePath, remoteSessionId, workspaceIdentity);
