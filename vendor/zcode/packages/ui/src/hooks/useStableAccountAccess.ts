...
import type { HawkNextAccountAccess, HawkNextProviderAccountAccess } from "@hawknext/shared";

type StableAccountAccess = HawkNextProviderAccountAccess | HawkNextAccountAccess;
