...
export type IntlShape = ReturnType<typeof useHawkNextIntl>["intl"];
...
export function CallCard({
  ...
  record: HawkNextModelTrajectoryRecord;
  index: number;
  inputMessages: HawkNextModelTrajectoryMessage[];
...
function SourceTitle({ record, intl }: { record: HawkNextModelTrajectoryRecord; intl: IntlShape }) {
  const callSource: NonNullable<HawkNextModelTrajectoryRecord["callSource"]> = record.callSource ?? {
    kind: "main",
  };
...
function sourceLabelId(callSource: NonNullable<HawkNextModelTrajectoryRecord["callSource"]>): string {
...
function MessageBlock({
  ...
  message: HawkNextModelTrajectoryMessage;
...
function ResponseBlock({
  ...
  response: NonNullable<HawkNextModelTrajectoryRecord["response"]>;
  callStartedAt: string;
  callDurationMs?: number;
