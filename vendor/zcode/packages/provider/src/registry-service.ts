...
export class ProviderRegistryService {
  ...
  async #runRefreshLoop(): Promise<void> {
    ...
    while (this.#completedGeneration < this.#requestedGeneration) {
      ...
      if (account.basedOnHawkNextBuiltinRevision !== config.hawknextBuiltinRevision) {
      ...
      try {
        const resolution = this.#resolver.resolve({
          hawknextBuiltinProviders: config.hawknextBuiltinProviders,
          hawknextBuiltinProviderTemplates: config.hawknextBuiltinProviderTemplates,
          personalProviders: config.personalProviders,
          hawknextBuiltinModelRules: config.hawknextBuiltinModelRules,
