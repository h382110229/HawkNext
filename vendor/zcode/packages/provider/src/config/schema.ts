import { z } from "zod";
import { modelConfigDataSchema } from "@hawknext/shared/model-config";
...
export function parseHawkNextBuiltinProviderConfigMap(input: unknown): ProviderConfigMap {
...
export function parseHawkNextBuiltinProviderConfigRules(input: unknown): {
...
export function parseHawkNextBuiltinModelConfigRules(input: unknown): ModelConfigRules {
