import type { AccountProviderUnavailableReason } from "@hawknext/shared/account-provider-state";
 ...
 */
export type { AccountProviderUnavailableReason } from "@hawknext/shared/account-provider-state";
