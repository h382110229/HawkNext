...
export class ProviderSettingsFacade {
  ...
  getView(): ProviderSettingsView {
    ...
    return createProviderSettingsView({
      ...
      hawknextBuiltinProviders: snapshot.config.hawknextBuiltinProviders,
      hawknextBuiltinProviderTemplates: snapshot.config.hawknextBuiltinProviderTemplates,
  ...
  resolveModelConfig(input: ResolveModelConfigInput): ModelConfigResolution {
    ...
    if (!("personalConfig" in input)) {
      const modelRules = ModelConfigRules.composeEffective(
        snapshot.config.hawknextBuiltinModelRules,
    ...
    const inheritedConfig = snapshot.config.hawknextBuiltinModelRules.resolve({
      providerId: input.providerId,
      templateId: provider.templateId,
      modelId: input.modelId,
      apiType: provider.config.api?.type,
...
function createProviderSettingsView(input: {
  revision: number;
  hawknextBuiltinProviders: ProviderRegistryServiceSnapshot["config"]["hawknextBuiltinProviders"];
  hawknextBuiltinProviderTemplates: ProviderRegistryServiceSnapshot["config"]["hawknextBuiltinProviderTemplates"];
  ...
  return Object.freeze({
    ...
    providerTemplates: Object.freeze(
      (input.hawknextBuiltinProviderTemplates ?? ProviderTemplateMap.empty())
        .entries()
