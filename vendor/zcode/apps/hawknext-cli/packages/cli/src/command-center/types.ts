...
import type { SupportedLocale, UiLocale } from "@hawknext/i18n";
import type { ModelSelection, HawkNextModelOption } from "@hawknext/shared";
import type {
...
export type CommandCenterModelOption = HawkNextModelOption;
...
export type CommandCenterCloudCnLoginOptions = CommandCenterLoginOptions;

export type CommandCenterCloudCnLoginResult = {
  browser?: {
    opened: boolean;
    reason?: string;
  };
...
export type CommandCenterApp = {
  ...
  readSubagents?: import("@hawknext/tui").TuiReadSubagents;
  readSubagentTranscript?: import("@hawknext/tui").TuiReadSubagentTranscript;
...
export type CommandCenterDeps = {
  ...
  ) => Promise<CommandCenterCloudCnLoginResult>;
