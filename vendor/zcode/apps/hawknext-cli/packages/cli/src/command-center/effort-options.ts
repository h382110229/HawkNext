import { getHawkNextCopy, type UiLocale } from "@hawknext/i18n";
import type { TuiEffortOption } from "@hawknext/tui";
...
export function thoughtLevelsToEffortOptions(
  ...
  const effortCopy = getHawkNextCopy(locale).tui.effort;
