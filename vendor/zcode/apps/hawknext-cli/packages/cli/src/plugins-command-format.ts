import { formatJson } from "@hawknext/core";
import type { GlobalOptions, JsonValue, RunContext } from "@hawknext/shared-types";
import type {
...
export function formatHumanAvailableList(plugins: readonly HawkNextAvailablePluginData[]): string {
...
export function formatHumanMarketplaceList(
  marketplaces: readonly HawkNextMarketplaceSummaryData[],
): string {
...
export function formatHumanPluginSet(result: SetHawkNextPluginEnabledResult): string {
...
export const formatPluginSetJson = (result: SetHawkNextPluginEnabledResult): string =>
  formatJson({
...
export function formatAvailablePluginJson(plugin: HawkNextAvailablePluginData) {
  return {
    id: plugin.id,
...
export function formatInstalledPluginJson(plugin: HawkNextInstalledPluginData) {
  return {
    enabled: plugin.enabled,
    id: plugin.id,
    marketplace: plugin.marketplace,
...
export function formatMarketplaceJson(marketplace: HawkNextMarketplaceSummaryData) {
  return {
    id: marketplace.id,
