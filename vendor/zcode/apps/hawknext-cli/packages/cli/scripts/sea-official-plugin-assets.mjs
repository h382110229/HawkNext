...
export const seaOfficialPluginAssetPrefix = "hawknext-official-plugins/";
...
export const officialSeaPlugins = [
  {
    ...
    marketplace: "hawknext-plugins-official",
    name: "node-repl-host",
...
function assertPluginRoot(pluginRoot, plugin) {
  if (!existsSync(join(pluginRoot, ".hawknext-plugin", "plugin.json"))) {
