...
import { modelSelectionSchema, type ModelSelection } from "@hawknext/shared/model-selection";
import type { ModelPropertiesData, ModelOptionSpecsData } from "@hawknext/shared/model-config";

export type { ModelSelection } from "@hawknext/shared/model-selection";
...
} from "@hawknext/shared/model-config";
