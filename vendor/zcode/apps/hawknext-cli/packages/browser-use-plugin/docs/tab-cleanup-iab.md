...
- IAB tabs persist for the lifetime of the current HawkNext process. Turn end, session end, an omitted finalize call,
...
- HawkNext does not restore these tabs after the HawkNext process exits.
