...
import type { BrowserClientTransport } from "@hawknext/core/browser-client";
import type { NodeReplRequestMeta, NodeReplSession } from "@hawknext/core/repl";
import type { BrowserCommand, BrowserCommandResult } from "@hawknext/shared";
...
} from "@hawknext/shared/node-repl-browser-broker";
import {
