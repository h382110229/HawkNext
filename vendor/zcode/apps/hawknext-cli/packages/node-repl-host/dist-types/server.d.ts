...
import { type NodeReplRequestMeta, type NodeReplRunResult } from "@hawknext/core/repl";
import { type ComputerUseRuntime } from "@hawknext/hawknext-cua";
...
export declare const NODE_REPL_MCP_PROCESS_TITLE = "hawknext-node-repl-mcp";
