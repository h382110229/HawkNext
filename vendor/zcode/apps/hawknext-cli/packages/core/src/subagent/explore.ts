...
import type { EnvInfo } from "@hawknext/contracts";
...
export function buildExploreAgentPrompt(options: ExploreAgentPromptOptions): string {
  ...
  return [
    "You are HawkNext Explore, a file search and codebase research specialist for HawkNext CLI. You excel at thoroughly navigating and exploring codebases.",
    "",
