...
} from "@hawknext/contracts/browser-control";
...
const locatorDetails = Symbol("hawknext.playwright.locatorDetails");
const setObjectWrapper = Symbol("hawknext.playwright.setObjectWrapper");
