...
import type { ModelMessageContent, ModelMessageContentBlock } from "@hawknext/contracts";
...
// MCS/provider projection 保持 provider-neutral，避免影响 OfficialModel-compatible 请求形态。
