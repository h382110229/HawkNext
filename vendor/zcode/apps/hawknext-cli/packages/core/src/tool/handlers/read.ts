...
const READ_PROVIDER_DESCRIPTION = [
  ...
  "- Reads videos (MP4, MOV, WEBM, …) and presents them as video input (subject to HawkNext's video input limit).",
...
// 与图片同构：tool result 只保留媒体 block；OfficialModel 系 provider 由
