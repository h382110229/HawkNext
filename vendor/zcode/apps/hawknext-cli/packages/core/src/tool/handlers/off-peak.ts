  ...
  const detail = (() => {
    switch (outcome.errorCategory) {
      ...
      case "eligibility_3101":
        return "The current account has no eligible Coding Plan connection for idle-time tasks. Tell the user to select a ZAI/CloudCN Coding Plan connection first.";
