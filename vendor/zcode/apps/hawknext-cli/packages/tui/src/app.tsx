import type { ModelUsageSummary, TodoItem, TurnId } from "@hawknext/contracts";
...
export function TuiApp({
  ...
  const initialCopy = getHawkNextCopy(initialLocale).tui;
  ...
  const copy = useMemo(() => getHawkNextCopy(locale), [locale]);
