...
import { SessionEventType, type SessionEvent } from "@hawknext/contracts";
import type {
  HawkNextSessionSubagentsResult,
  HawkNextSessionRunningSubagent,
...
export type SubagentItem = HawkNextSessionRunningSubagent | HawkNextSessionEndedSubagent;
const EMPTY_DIRECTORY: HawkNextSessionSubagentsResult = {
  revision: 0,
  childSessionIds: [],
  running: [],
  ended: { total: 0, items: [] },
