...
export const enUS: HawkNextCopy = {
  locale: "en-US",
  cli: {
    errors: {
    ...
    help: (version) => `hawknext ${version}

Usage:
  hawknext [command] [options]

With no command, hawknext opens the full-screen TUI.

Commands:
  app-server Run the HawkNext Protocol stdio app server
  commands   List custom slash commands (\`commands list\`)
  doctor     Inspect runtime and packaging assumptions
  login [zai|cloud-cn]  Sign in through browser authorization
  logout     Remove the shared  login credentials
...
Slash Commands:
  ...
  /login                Choose  or CloudCN browser login
  /logout               Remove the shared  login credentials
...
`,
  ...
  tui: {
    ...
    loginSetup: {
      ...
      options: {
        cloudCnApiKey: {
          inputPrimary: "Enter CloudCN Coding Plan API Key",
          inputSecondary: "Paste the key here. It is hidden while typing.",
          primary: "CloudCN Coding Plan API Key",
          secondary: "Paste a Coding Plan API key manually.",
        },
        cloudCnOauth: {
          pendingPrimary: "Waiting for CloudCN authorization",
          pendingSecondary:
            "Complete sign-in in your browser. Authorization is detected automatically.",
          primary: "CloudCN Coding Plan",
          secondary: "Open browser login; authorization is detected automatically.",
        },
        zaiApiKey: {
          inputPrimary: "Enter  Coding Plan API Key",
          inputSecondary: "Paste the key here. It is hidden while typing.",
          primary: " Coding Plan API Key",
          secondary: "Paste a Coding Plan API key manually.",
        },
        zaiOauth: {
          pendingPrimary: "Waiting for  authorization",
          pendingSecondary:
    ...
    terminal: {
      ...
      starting: "Starting HawkNext... Ctrl+C to exit",
    },
    transcript: {
      compact: {
