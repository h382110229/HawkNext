import type { EmbeddedSearchBackend } from "@hawknext/contracts";
import { getRuntimeToolRuntime } from "@hawknext/shared";

const EMBEDDED_SEARCH_COMMAND_ENV = "HAWKNEXT_EMBEDDED_SEARCH_COMMAND";
