...
import { digestSummary, workspaceIdentitySummary } from "@hawknext/core";
import {
...
} from "@hawknext/shared/workspace-hook-mutation";
...
export function createWorkspaceHookReviewMutationPort(
  ...
  const editableConfigPath = resolve(workingDirectory, ".hawknext", "config.json");
