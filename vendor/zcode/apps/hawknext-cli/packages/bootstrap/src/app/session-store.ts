...
import { SqliteSessionStore } from "@hawknext/adapters/storage";
import { resolvePath, type ConfigResult } from "@hawknext/adapters/config";
import {
...
import type { ModelSelection } from "@hawknext/provider";
...
export async function openStartupSessionStore(
  ...
  startupTimer.start("HawkNext SQLite migration started", {
    context: { dbPath },
  ...
  startupTimer.mark("HawkNext SQLite migration completed", {
    context: { dbPath },
