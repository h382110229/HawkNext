import { createDefaultFileWorkspaceHookTrustStore } from "@hawknext/adapters/storage";
import {
...
import { SessionEventType } from "@hawknext/contracts";
import type {
  Logger,
  SessionId,
...
import type { WorkspaceHookRuntimeRoot } from "@hawknext/shared/workspace-hook-discovery";
import {
...
export function createWorkspaceHookRuntimeSecurity(input: {
  ...
  /** 测试注入临时 HOME；生产不传，Trust store 落在真实 ~/.hawknext/security。 */
  homeDir?: string;
