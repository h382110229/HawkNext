...
import type { DynamicWorkflowRunProgressPayload, Logger, SessionId } from "@hawknext/contracts";
 ...
 *
 *   HawkNextApp ──1:1── AgentRuntime ──1:1── sessionId        （create-app：`new AgentRuntime(sessionId, …)`）
