...
import { createNodeExecutionAdapter } from "@hawknext/adapters/exec";
...
} from "@hawknext/adapters/workflow";
import {
  AgentRuntime,
...
import type { PrepareUserExecutionBoundary, HawkNextAppOptions } from "./types.js";
...
function createWorkflowChildRuntime(
  ...
  return new AgentRuntime(
    ...
    {
      ...deps.runtimeConfig,
      agentName: options.workflowKind === "expert" ? "hawknext-expert" : "hawknext-workflow",
      mode: "yolo",
    ...
    },
    {
      ...
      ...deps.runtime.createChildClientPorts({
        ...
        agentType: options.workflowKind === "expert" ? "hawknext-expert" : "hawknext-workflow",
