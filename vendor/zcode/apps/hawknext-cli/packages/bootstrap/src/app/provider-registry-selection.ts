import { ModelErrorCode, ModelProtocolError } from "@hawknext/contracts";
import {
...
function toModelOption(provider: Provider, model: ProviderModel): HawkNextModelOption {
