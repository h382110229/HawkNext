import type { McpServerConfig, PluginLoadOutcome } from "@hawknext/contracts";
...
export function resolveBuiltInNodeReplMcpServers(input: {
  ...
  const nodeRepl = createBundledMcpRuntimeConfig({
    ...
    env: {
      ...
      ...(browserUsePackage ? { HAWKNEXT_PLUGIN_ROOT: browserUsePackage.rootPath } : {}),
      ...(cuaPackage ? { HAWKNEXT_CUA_PLUGIN_ROOT: cuaPackage.rootPath } : {}),
    },
