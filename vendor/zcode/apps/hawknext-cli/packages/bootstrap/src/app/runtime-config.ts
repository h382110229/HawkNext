...
import { resolveInitialModelSelection, type ModelSelectionOptions } from "@hawknext/provider";
import { resolveBashTimeoutPolicy, type AgentProfile, type AgentRuntimeConfig } from "@hawknext/core";
import { type BuiltInSubagentModelSelectionOverrides } from "@hawknext/shared";
import {
...
export function resolveAppRuntimeConfig(input: {
  ...
  const runtimeConfig: AgentRuntimeConfig = {
    ...
    // 仅接受显式传入的会话级工具面（HawkNext Protocol session/create 或 CLI
