...
// 1. URI ref（hawknext-artifact:// 等带 scheme:/）——经 attachment chunk transaction 寄存的内容引用：
...
import type { TurnAttachment } from "@hawknext/core";
...
async function mapAttachmentRef(app: HawkNextApp, ref: AttachmentRef): Promise<TurnAttachment> {
