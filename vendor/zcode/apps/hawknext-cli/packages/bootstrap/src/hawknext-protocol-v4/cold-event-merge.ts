...
interface PersistedConversationMaterializationStore {
  getSession(sessionId: import("@hawknext/contracts").SessionId): Promise<{
    title?: string;
    revert?: {
      branchCutAfterMessageID?: import("@hawknext/contracts").MessageId;
      branchGeneration?: number;
      createdMessageID?: import("@hawknext/contracts").MessageId;
      keptMessageIDs?: import("@hawknext/contracts").MessageId[];
      targetMessageID?: import("@hawknext/contracts").MessageId;
    };
  } | null>;
  messages(input: { sessionID: import("@hawknext/contracts").SessionId }): Promise<MessageWithParts[]>;
  readTarget(input: {
    sessionID: import("@hawknext/contracts").SessionId;
...
export async function loadPersistedConversationMaterialization(input: {
  ...
  const sessionID = input.sessionId as import("@hawknext/contracts").SessionId;
