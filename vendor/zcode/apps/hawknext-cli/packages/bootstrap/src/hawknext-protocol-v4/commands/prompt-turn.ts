...
import { type TurnBackgroundAttribution, type TurnInputIntentMetadata } from "@hawknext/contracts";
import type { TurnAttachment } from "@hawknext/core";
import type { SendInputOptions, SendInputResult } from "../../app/types.js";
import { runWithSessionResidencyFinalization } from "../../hawknext-protocol/session-residency.js";
