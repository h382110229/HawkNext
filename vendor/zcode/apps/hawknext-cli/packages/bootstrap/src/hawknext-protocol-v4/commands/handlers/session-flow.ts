...
import type { ModelSelection } from "@hawknext/shared";
import { createModelExecutionContext } from "../../../hawknext-protocol/model-execution.js";
...
async function stop(
  ...
  host.logger?.info?.("v4 stop foreground execution inspected", {
    ...
    expectedForegroundExecutionId: payload.expectedForegroundExecutionId,
    module: "bootstrap.hawknext_protocol_v4.commands",
...
import { resolveExecutionState } from "@hawknext/shared";
