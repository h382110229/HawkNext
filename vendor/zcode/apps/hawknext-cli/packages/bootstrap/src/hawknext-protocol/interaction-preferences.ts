import { hawknextWorkspaceUpdateInteractionPreferencesParamsSchema } from "@hawknext/shared";
...
export async function updateInteractionPreferences(
  ...
  const params = parseParams(hawknextWorkspaceUpdateInteractionPreferencesParamsSchema, rawParams);
