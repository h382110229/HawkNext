import { hawknextWorkspaceUpdateDynamicWorkflowPolicyParamsSchema } from "@hawknext/shared";
...
export async function updateDynamicWorkflowPolicy(
  ...
  const params = parseParams(hawknextWorkspaceUpdateDynamicWorkflowPolicyParamsSchema, rawParams);
