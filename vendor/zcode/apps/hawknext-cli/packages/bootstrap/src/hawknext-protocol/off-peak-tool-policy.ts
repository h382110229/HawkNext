import { hawknextWorkspaceUpdateOffPeakToolPolicyParamsSchema } from "@hawknext/shared";
...
export async function updateOffPeakToolPolicy(
  ...
  const params = parseParams(hawknextWorkspaceUpdateOffPeakToolPolicyParamsSchema, rawParams);
