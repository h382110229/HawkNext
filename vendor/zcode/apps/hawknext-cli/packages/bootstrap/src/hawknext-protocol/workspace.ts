import { parseRemoteWorkspaceIdentity, type HawkNextWorkspaceRef } from "@hawknext/shared";
 ...
 */
export function resolveWorkspaceRefFromId(workspaceId: string): HawkNextWorkspaceRef {
