import { hawknextWorkspaceUpdateModelIoPreferencesParamsSchema } from "@hawknext/shared";
...
export async function updateModelIoPreferences(
  ...
  const params = parseParams(hawknextWorkspaceUpdateModelIoPreferencesParamsSchema, rawParams);
