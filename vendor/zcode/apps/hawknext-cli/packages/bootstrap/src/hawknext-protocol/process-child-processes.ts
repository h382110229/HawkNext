import type { McpTrackedProcess } from "@hawknext/adapters";
import type { HawkNextProcessChildProcessesResult } from "@hawknext/shared";
...
): HawkNextProcessChildProcessesResult {
  return {
