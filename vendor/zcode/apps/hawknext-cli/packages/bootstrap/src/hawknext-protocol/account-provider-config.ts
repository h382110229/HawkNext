import {
  hawknextProviderUpdateAccountConfigParamsSchema,
  type HawkNextProviderUpdateAccountConfigResult,
...
export async function updateAccountProviderConfig(
  ...
  params: unknown,
): Promise<HawkNextProviderUpdateAccountConfigResult> {
  const envelope = parseParams(hawknextProviderUpdateAccountConfigParamsSchema, params);
