...
import { getHawkNextAgentModeSelectOptions, normalizeAvailableHawkNextMode } from "@hawknext/shared";
import type { HawkNextSessionSettingsState, HawkNextSlashCommand } from "@hawknext/shared";
import type { WorkspaceConfigState } from "@hawknext/shared/hawknext-protocol-v4";
 ...
 * 创建临时 app 并被 MCP close 拖住协议通道（见 desktop warmUpHawkNextAgent 的注释）。
