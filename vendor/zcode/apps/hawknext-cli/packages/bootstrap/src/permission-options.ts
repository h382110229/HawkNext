import type { PermissionOptionsPolicy, PermissionUpdate } from "@hawknext/contracts";
import { OFFICIAL_CUA_PERMISSION_RULE_TOOL_NAME, type HawkNextPermissionOption } from "@hawknext/shared";
...
export function buildProtocolPermissionOptions(
  ...
  return [
    ...
    // **没有** permissionUpdates——wire 上 hawknextPermissionUpdateSchema 是 strict，会话语义由
