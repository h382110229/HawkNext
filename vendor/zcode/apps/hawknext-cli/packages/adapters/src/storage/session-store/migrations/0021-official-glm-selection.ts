...
WHERE type = 'runtime/model_selection' AND CASE WHEN json_valid(data) THEN
  json_extract(data, '$.modelSelection.providerId') IN ('account:zai-start-plan', 'account:cloud-cn-start-plan', 'account:zai-individual-coding-plan', 'account:cloud-cn-individual-coding-plan', 'account:zai-team-coding-plan', 'account:cloud-cn-team-coding-plan')
