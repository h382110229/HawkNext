...
const officialProviders = [
  ...
  "account:cloud-cn-start-plan",
  "account:zai-individual-coding-plan",
  "account:cloud-cn-individual-coding-plan",
  "account:zai-team-coding-plan",
  "account:cloud-cn-team-coding-plan",
];
...
WITH last_user AS (
  ...
  SELECT session_id,
    CASE trim(json_extract(data, '$.modelSelection.providerId'))
      WHEN 'builtin:cloud-cn' THEN 'cloud-cn-api'
      WHEN 'builtin:zai' THEN 'zai-api'
      WHEN 'builtin:cloud-cn-start-plan' THEN 'account:cloud-cn-start-plan'
      WHEN 'builtin:zai-start-plan' THEN 'account:zai-start-plan'
      WHEN 'builtin:cloud-cn-coding-plan' THEN 'account:cloud-cn-individual-coding-plan'
