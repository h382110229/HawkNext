...
import { ModelApiActorKind, ModelApiOperation, ModelRequestSessionType } from "@hawknext/contracts";
import { isOpenCodeGoBaseUrl } from "./opencode-session.js";
import type { ModelStatusContext } from "./runner-status.js";

const MODEL_TRACE_HEADER = "x-hawknext-trace-id";
...
const MODEL_SESSION_TYPE_HEADER = "x-hawknext-session-type";
