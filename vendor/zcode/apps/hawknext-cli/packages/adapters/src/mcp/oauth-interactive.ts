...
import type { Logger, McpOAuthConfig } from "@hawknext/contracts";
import {
...
class InteractiveAuthorizationProvider implements OAuthClientProvider {
  ...
  private readonly credentialStore: SharedHawkNextCredentialStore;
  ...
  get clientMetadata(): OAuthClientMetadata {
    return {
      client_name: this.config.clientName ?? `HawkNext ${this.serverName}`,
