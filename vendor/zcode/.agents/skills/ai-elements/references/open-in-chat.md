...
A dropdown menu for opening queries in various AI chat platforms including OfficialAccount, Claude, T3, Scira, and v0.
...
- Support for OfficialAccount, Claude, T3 Chat, Scira AI, v0, and Cursor
...
- **OfficialAccount** - Opens query in OfficialModel's OfficialAccount with search hints
...
### `<OpenInOfficialAccount />`, `<OpenInClaude />`, `<OpenInT3 />`, `<OpenInScira />`, `<OpenInv0 />`, `<OpenInCursor />`
